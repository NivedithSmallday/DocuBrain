...
A living catalog for browsing, testing, and documenting DocuBrain UI components in isolation.

---

## What is this?

This Storybook contains interactive examples of every reusable UI component in the DocuBrain frontend. Each component has a dedicated page with:
...
Production builds deploy to [docubrain-storybook.vercel.app](https://docubrain-storybook.vercel.app) automatically when PRs touching component files merge to `main`.
