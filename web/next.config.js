...
const nextConfig = {
  ...
  output: "standalone",
  transpilePackages: ["@docubrain/opal"],
  typedRoutes: true,
  reactCompiler: true,
  images: {
  ...
  async redirects() {
    return [
      ...
      // TODO: Remove these redirects in v4.0 — https://linear.app/docubrain-app/issue/ENG-3771
      {
...
const sentryWebpackPluginOptions = {
  org: process.env.SENTRY_ORG || "docubrain-vl",
  project: process.env.SENTRY_PROJECT || "docubrain-web",
