...
export interface AppInputBarProps {
  ...
  setPresentingDocument?: (document: MinimalDocubrainDocument) => void;
...
const AppInputBar = React.memo(
  ({
    ...
    // Convert ProjectFile to MinimalDocubrainDocument format for viewing
    const handleFileClick = useCallback(
      (file: ProjectFile) => {
        if (!setPresentingDocument) return;

        const documentForViewer: MinimalDocubrainDocument = {
    ...
    const showDeepResearch = useMemo(() => {
      ...
      // https://linear.app/docubrain-app/issue/ENG-3818/re-enable-deep-research-in-projects
      return (
        !isProjectWorkflow &&
      ...
      >
        ...
        <div className="flex flex-row items-center gap-1">
          ...
          <Button
            ...
            id="docubrain-chat-input-send-button"
            icon={
              isClassifying
                ? SimpleLoader
          ...
          <div className="flex flex-row items-center w-full">
            ...
            >
              <Popover.Anchor asChild>
                ...
                >
                  <textarea
                    id="docubrain-chat-input-textarea"
                    role="textarea"
                    ref={textAreaRef}
                    onPaste={handlePaste}
