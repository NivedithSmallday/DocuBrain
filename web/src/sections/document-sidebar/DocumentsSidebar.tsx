...
import { MinimalDocubrainDocument, DocubrainDocument } from "@/lib/search/interfaces";
...
// Build an DocubrainDocument from basic file info
const buildDocubrainDocumentFromFile = (
  id: string,
  name?: string | null,
...
interface DocumentsSidebarProps {
  closeSidebar: () => void;
  selectedDocuments: DocubrainDocument[] | null;
  modal: boolean;
  setPresentingDocument: Dispatch<SetStateAction<MinimalDocubrainDocument | null>>;
}
              ...
              <ChatDocumentDisplayWrapper>
                {humanFileDescriptors.map((file) => (
                  <ChatDocumentDisplay
                    ...
                    setPresentingDocument={setPresentingDocument}
                    modal={modal}
                    document={buildDocubrainDocumentFromFile(
                      file.id,
                      file.name,
                      false
                    )}
