...
import { useGoogleDriveCredentials } from "@/app/admin/connectors/[connector]/pages/utils/hooks";
...
export default function AddConnector({
  ...
  const credentialActivated =
    (connector === "google_drive" && liveGDriveCredential) || currentCredential;
        ...
        try {
          ...
          const connectorCreationPromise = (async () => {
            ...
            if (credentialActivated && isSuccess && response) {
              const credential = currentCredential || liveGDriveCredential;
          ...
          {formStep == 1 && (
            <CardSection className="w-full py-8 flex gap-y-6 flex-col max-w-3xl px-12 mx-auto">
              <DynamicConnectionForm
                ...
                connector={connector}
                currentCredential={
                  currentCredential || liveGDriveCredential || null
                }
              />
