...
// Check if both supported build-mode providers are configured.
function checkAllProvidersConfigured(
  ...
  return (
    configuredProviders.has(LLMProviderName.OLLAMA_CHAT) &&
    configuredProviders.has(LLMProviderName.OPENAI_COMPATIBLE)
  );
}
