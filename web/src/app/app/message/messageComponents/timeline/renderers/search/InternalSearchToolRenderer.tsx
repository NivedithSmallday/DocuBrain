...
const resultToSourceInfo = (doc: DocubrainDocument): SourceInfo => ({
  id: doc.document_id,
          ...
          content: (
            <div className="flex flex-col">
              ...
              <SearchChipList
                ...
                getKey={(doc: DocubrainDocument, index: number) =>
                  doc.document_id ?? `result-${index}`
                }
                toSourceInfo={(doc: DocubrainDocument) => resultToSourceInfo(doc)}
