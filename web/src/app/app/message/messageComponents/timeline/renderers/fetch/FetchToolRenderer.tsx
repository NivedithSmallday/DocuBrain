...
const documentToSourceInfo = (doc: DocubrainDocument): SourceInfo => ({
  id: doc.document_id,
          ...
          <div className="flex flex-col">
            ...
            {displayDocuments ? (
              <SearchChipList
                ...
                getKey={(doc: DocubrainDocument) => doc.document_id}
                toSourceInfo={(doc: DocubrainDocument) => documentToSourceInfo(doc)}
                onClick={(doc: DocubrainDocument) => {
