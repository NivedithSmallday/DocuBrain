...
import {
  LoadedDocubrainDocument,
  MinimalDocubrainDocument,
  DocubrainDocument,
...
export const MemoizedAnchor = memo(
  ({
    ...
    docs?: DocubrainDocument[] | null;
    userFiles?: ProjectFile[] | null;
    citations?: CitationMap;
    updatePresentingDocument: (doc: MinimalDocubrainDocument) => void;
    href?: string;
    ...
    if (value?.startsWith("[") && value?.endsWith("]")) {
      ...
      if (match) {
        ...
        if (match_item !== undefined) {
          ...
          let associatedDoc: DocubrainDocument | null = null;
...
export const MemoizedLink = memo(
  ({
    ...
    const documentSourceInfo = useMemo(() => {
      ...
      return documentToSourceInfo(document as DocubrainDocument);
    }, [document]);
    ...
    const handleSourceClick = useCallback(() => {
      if (document && updatePresentingDocument) {
        openDocument(document as DocubrainDocument, updatePresentingDocument);
    ...
    if (value?.toString().startsWith("*")) {
      ...
      const displayName = document
        ? getDisplayNameForSource(document as DocubrainDocument)
