...
export const Default: Story = {
  args: {
    href: "https://docs.docubrain.app",
    children: "DocuBrain Documentation",
  },
};

export const CustomClassName: Story = {
  args: {
    href: "https://github.com/docubrain-dot-app/docubrain",
...
export const InContext: Story = {
  render: () => (
    <p className="font-main-content-body text-text-04">
      ...
      <InlineExternalLink href="https://docs.docubrain.app">
        official documentation
      </InlineExternalLink>{" "}
      or check out the{" "}
      <InlineExternalLink href="https://github.com/docubrain-dot-app/docubrain">
        source code
      </InlineExternalLink>
      .
    </p>
