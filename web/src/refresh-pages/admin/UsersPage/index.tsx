    ...
    <SettingsLayouts.Root width="lg">
      ...
      >
        <Message
          ...
          description="DocuBrain is transitioning to group-based permissions for more granular access control. Curator and Global Curator roles will be replaced by configurable group permissions. We recommend reviewing current role assignments to ensure a smooth transition."
          actions="Learn more"
          actionIcon={SvgExternalLink}
          onAction={() =>
            window.open(
              "https://docs.docubrain.app/admins/permissions/whats_changing",
              "_blank",
              "noopener,noreferrer"
            )
          }
