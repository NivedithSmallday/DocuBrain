  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will no longer be able to join DocuBrain with this invite.
      </Text>
    </ConfirmationModalLayout>
  );
}
  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will immediately lose access to DocuBrain. Their sessions and agents will be
  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will regain access to DocuBrain.
      </Text>
    </ConfirmationModalLayout>
  );
}
  ...
  return (
    ...
    >
      <Text as="p" text03>
        ...
        will be permanently removed from DocuBrain. All of their session history will
