    ...
    <Section gap={2}>
      <Section gap={0.75}>
        ...
        <Card>
          <InputLayouts.Horizontal
            title="Default Model"
            description="This model will be used by DocuBrain by default in your chats."
          >
            <LLMPopover
      ...
      <Section gap={0.75}>
        ...
        <Card>
          <InputLayouts.Horizontal
            ...
            description="Let DocuBrain reference stored memories in chats."
          >
            <Switch
          ...
          <InputLayouts.Horizontal
            ...
            description="Let DocuBrain generate and update stored memories."
          >
            <Switch
        ...
        >
          <Section gap={0.5} alignItems="start">
            <Text>
              ...
              lose access to DocuBrain. This action cannot be undone.
            </Text>
    ...
    <>
      {showDisconnectConfirmation && (
        ...
        >
          <Section gap={0.5} alignItems="start">
            <Text>
              DocuBrain will no longer be able to access or search content from your{" "}
