...
export interface MinimalDocubrainDocument {
  document_id: string;
  semantic_identifier: string | null;
}

export interface DocubrainDocument extends MinimalDocubrainDocument {
  link: string;
  source_type: ValidSources;
  blurb: string;
  boost: number;
...
export interface LoadedDocubrainDocument extends DocubrainDocument {
  icon: React.FC<{ size?: number; className?: string }>;
}

export interface SearchDocubrainDocument extends DocubrainDocument {
  is_relevant: boolean;
  relevance_explanation: string;
}

export interface FilteredDocubrainDocument extends DocubrainDocument {
  included: boolean;
}
...
export interface SearchResponse {
  ...
  answer: string | null;
  quotes: Quote[] | null;
  documents: SearchDocubrainDocument[] | null;
...
export interface SearchRequestArgs {
  ...
  updateDocs: (documents: DocubrainDocument[]) => void;
 ...
 * Matches backend/docubrain/context/search/models.py BaseFilters
 */
