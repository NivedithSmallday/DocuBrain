...
export const useGoogleAppCredential = (_service: "google_drive") => {
  const endpoint = `/api/manage/admin/connector/${GOOGLE_SERVICES.GOOGLE_DRIVE}/app-credential`;
...
export const useGoogleServiceAccountKey = (
  ...
  const endpoint = `/api/manage/admin/connector/${GOOGLE_SERVICES.GOOGLE_DRIVE}/service-account-key`;
...
export const refreshAllGoogleData = (
  ...
  const service = GOOGLE_SERVICES.GOOGLE_DRIVE;
