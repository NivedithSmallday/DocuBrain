...
export const SWR_KEYS = {
  ...
  // ── Google Connectors ─────────────────────────────────────────────────────
  googleConnectorAppCredential: (service: "google-drive") =>
    `/api/manage/admin/connector/${service}/app-credential`,
  googleConnectorServiceAccountKey: (service: "google-drive") =>
    `/api/manage/admin/connector/${service}/service-account-key`,
  googleConnectorCredentials: (service: "google-drive") =>
    `/api/manage/admin/connector/${service}/credentials`,
  googleConnectorPublicCredential: (service: "google-drive") =>
