...
export const MarkdownLink: Story = {
  args: {
    font: "main-ui-body",
    color: "text-05",
    children: markdown("Visit [DocuBrain](https://www.docubrain.app/) for more info"),
  },
};
...
export const MarkdownCombined: Story = {
  args: {
    ...
    color: "text-05",
    children: markdown(
      "*Hello*, **world**! Check out [DocuBrain](https://www.docubrain.app/) and run `docubrain start` to begin."
    ),
  },
};
