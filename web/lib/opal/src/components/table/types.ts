...
export type DocubrainColumnKind = "qualifier" | "data" | "display" | "actions";

// ---------------------------------------------------------------------------
// Column definitions (discriminated union on `kind`)
// ---------------------------------------------------------------------------

interface DocubrainColumnBase<TData> {
  kind: DocubrainColumnKind;
...
export interface DocubrainQualifierColumn<TData> extends DocubrainColumnBase<TData> {
  kind: "qualifier";
...
export interface DocubrainDataColumn<TData> extends DocubrainColumnBase<TData> {
  kind: "data";
...
export interface DocubrainDisplayColumn<TData> extends DocubrainColumnBase<TData> {
  kind: "display";
}

/** Actions column — fixed column with visibility/sorting popovers. */
export interface DocubrainActionsColumn<TData> extends DocubrainColumnBase<TData> {
  kind: "actions";
...
export type DocubrainColumnDef<TData> =
  | DocubrainQualifierColumn<TData>
  | DocubrainDataColumn<TData>
  | DocubrainDisplayColumn<TData>
  | DocubrainActionsColumn<TData>;
