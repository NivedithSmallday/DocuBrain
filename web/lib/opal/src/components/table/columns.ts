...
interface TableColumnsBuilder<TData> {
  ...
  qualifier(config?: QualifierConfig<TData>): DocubrainQualifierColumn<TData>;
  ...
  displayColumn(config: DisplayColumnConfig<TData>): DocubrainDisplayColumn<TData>;

  /** Create an actions column (visibility/sorting popovers). */
  actions(config?: ActionsConfig<TData>): DocubrainActionsColumn<TData>;
}
