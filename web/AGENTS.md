...
This file is the single source of truth for frontend coding standards across all DocuBrain frontend
...
**Reason:** We have a very carefully curated selection of icons that match our DocuBrain guidelines. We do NOT want to muddy those up with different aesthetic stylings.
...
If you need help with this step, reach out to `raunak@docubrain.app`.
...
<Text font="main-ui-body" color="text-05">
  {markdown("*Hello*, **world**! Visit [DocuBrain](https://docubrain.app) and run `docubrain start`.")}
</Text>
...
**Reason:** We've put in a lot of effort to unify the components that are rendered in the DocuBrain app. Using raw components breaks the entire UI of the application, and leaves it in a muddier state than before.
...
```typescript
// ✅ Good - Use custom DocuBrain color classes
