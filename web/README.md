<!-- DOCUBRAIN_METADATA={"link": "https://github.com/docubrain-dot-app/docubrain/blob/main/web/README.md"} -->
...
> [!TIP]
> Packages are installed automatically when switching branches after `package.json` changes with [pre-commit](https://github.com/docubrain-dot-app/docubrain/blob/main/CONTRIBUTING.md#formatting-and-linting) configured.
...
INTERNAL_URL=https://st-dev.docubrain.app/api
...
# To get this value:
#   1. Go to https://st-dev.docubrain.app (or your target backend URL) and log in
...
For more information, see [tools/ods/README.md](https://github.com/docubrain-dot-app/docubrain/blob/main/tools/ods/README.md#screenshot-diff---visual-regression-testing).
