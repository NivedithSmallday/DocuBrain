...
test.describe("Message Edit and Regenerate Tests", () => {
  ...
  test("Complete message editing functionality", async ({ page }) => {
    ...
    // Test cancel editing
    let userMessage = page.locator("#docubrain-human-message").first();
    ...
    messageContent = await page
      .locator("#docubrain-human-message")
      .first()
      .textContent();
    ...
    userMessage = page.locator("#docubrain-human-message").first();
    await userMessage.hover();
    editButton = userMessage
      .locator('[data-testid="HumanMessage/edit-button"]')
      .first();
  ...
  test("Message regeneration with model selection", async ({ page }) => {
    ...
    const aiMessage = page.locator('[data-testid="docubrain-ai-message"]').first();
  ...
  test("Message editing with files", async ({ page }) => {
    ...
    const humanMessage = page.locator("#docubrain-human-message").first();
    ...
    const editedHumanMessage = page.locator("#docubrain-human-message").first();
    ...
    const editedFileDisplay = editedHumanMessage.locator("#docubrain-file");
