 ...
 *
 * This server validates Google OAuth tokens that are passed through from DocuBrain.
 * It calls Google's tokeninfo endpoint to verify the token is valid.
 *
 * For testing pass-through OAuth scenarios where DocuBrain forwards the user's
