...
_PATCH_QUEUE_LEN = (
    "docubrain.background.celery.tasks.user_file_processing.tasks.celery_get_queue_length"
)
...
class TestTaskExpiry:
    ...
    def test_send_task_called_with_expires(
        ...
        try:
            ...
            for call in mock_app.send_task.call_args_list:
                assert call.args[0] == DocubrainCeleryTask.PROCESS_SINGLE_USER_FILE
                assert call.kwargs.get("queue") == DocubrainCeleryQueues.USER_FILE_PROCESSING
                assert (
