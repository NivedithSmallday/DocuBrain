...
from docubrain.context.search.federated.slack_search import fetch_and_cache_channel_metadata
...
from docubrain.db.models import LLMProvider
from docubrain.db.models import Persona
from docubrain.db.models import Persona__DocumentSet
...
from docubrain.docubrainbot.slack.listener import process_message
from docubrain.docubrainbot.slack.models import ChannelType
from docubrain.db.tools import get_builtin_tool
from docubrain.tools.built_in_tools import SearchTool
...
class TestSlackBotFederatedSearch:
    ...
    def _setup_slack_mocks(self, channel_name: str) -> tuple[list, list]:
        ...
        patches = [
            ...
            patch("docubrain.context.search.federated.slack_search.query_slack"),
            patch("docubrain.docubrainbot.slack.listener.get_channel_type_from_id"),
            patch("docubrain.context.search.utils.get_query_embeddings"),
        ]
    ...
    def _setup_query_slack_mock(
        ...
        from docubrain.context.search.federated.slack_search import SlackQueryResult
    ...
    @patch("docubrain.utils.gpu_utils.fast_gpu_status_request", return_value=False)
    @patch(
        "docubrain.document_index.vespa.index.VespaIndex.hybrid_retrieval", return_value=[]
    )
...
@patch("docubrain.context.search.federated.slack_search.get_redis_client")
@patch("docubrain.context.search.federated.slack_search.WebClient")
...
def test_slack_channel_config_eager_loads_persona(db_session: Session) -> None:
    ...
    """
    from docubrain.db.slack_channel_config import (
