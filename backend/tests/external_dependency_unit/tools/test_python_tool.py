...
# from docubrain.chat.turn.models import ChatTurnContext
# from docubrain.configs.app_configs import CODE_INTERPRETER_BASE_URL
# from docubrain.file_store.models import ChatFileType
# from docubrain.file_store.models import InMemoryChatFile
# from docubrain.file_store.utils import get_default_file_store
...
# from docubrain.tools.tool_implementations.python.python_tool import PythonTool
# from docubrain.tools.tool_implementations_v2.code_interpreter_client import (
#     CodeInterpreterClient,
# )
# from docubrain.tools.tool_implementations_v2.python import _python_execution_core
# from docubrain.tools.tool_implementations_v2.python import python
# from docubrain.tools.tool_implementations_v2.tool_result_models import (
...
#     with patch(
#         "docubrain.tools.tool_implementations_v2.python.get_tool_by_name"
#     ) as mock_get_tool:
#         mock_tool = Mock()
#         mock_tool.id = 1
...
#         with patch(
#             "docubrain.tools.tool_implementations_v2.python.CODE_INTERPRETER_DEFAULT_TIMEOUT_MS",
#             1000,
#         ):
#             # Execute code
...
#     with patch(
#         "docubrain.tools.tool_implementations.python.python_tool.CODE_INTERPRETER_BASE_URL",
#         "http://localhost:8000",
#     ):
...
#     ) as mock_get_tool:
#         with patch(
#             "docubrain.tools.tool_implementations_v2.python.CodeInterpreterClient"
...
#         with patch(
#             "docubrain.tools.tool_implementations_v2.python.CODE_INTERPRETER_MAX_OUTPUT_LENGTH",
#             5000,
#         ):
#             mock_tool = Mock()
#             mock_tool.id = 1
...
import docubrain.tools.tool_implementations.python.code_interpreter_client as ci_mod
from docubrain.chat.process_message import handle_stream_message_objects
from docubrain.db.models import Persona
from docubrain.db.tools import get_builtin_tool
from docubrain.file_store.models import ChatFileType
from docubrain.file_store.models import FileDescriptor
from docubrain.server.features.projects.api import upload_user_files
from docubrain.server.query_and_chat.chat_backend import get_chat_session
...
from docubrain.server.query_and_chat.streaming_models import ToolCallArgumentDelta
from docubrain.tools.tool_implementations.python.python_tool import PythonTool
...
def _clear_health_cache() -> None:
    ...
    import docubrain.tools.tool_implementations.python.code_interpreter_client as mod
...
def test_code_interpreter_receives_chat_files(
    ...
    with (
        ...
        patch(
            "docubrain.tools.tool_implementations.python.code_interpreter_client.CODE_INTERPRETER_BASE_URL",
            mock_url,
        ),
    ):
