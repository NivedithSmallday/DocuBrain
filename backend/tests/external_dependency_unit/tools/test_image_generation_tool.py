...
# from docubrain.tools.tool_implementations.images.image_generation_tool import (
...
#     ImageGenerationTool,
# )
# from docubrain.tools.tool_implementations.images.image_generation_tool import ImageShape
