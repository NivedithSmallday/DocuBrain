...
from docubrain.llm.model_response import ChatCompletionDeltaToolCall
from docubrain.llm.model_response import Delta
from docubrain.llm.model_response import FunctionCall
from docubrain.llm.model_response import ModelResponse
from docubrain.llm.model_response import ModelResponseStream
from docubrain.llm.model_response import StreamingChoice
...
def use_mock_llm() -> Generator[MockLLMController, None, None]:
    ...
    with patch("docubrain.chat.process_message.get_llm_for_persona", return_value=mock_llm):
        yield mock_llm
