...
from ee.docubrain.external_permissions.jira.group_sync import jira_group_sync
...
_EXPECTED_JIRA_GROUPS = [
    ...
    ExternalUserGroupSet(
        ...
        user_emails={"founders@docubrain.app", "hagen@danswer.ai", "pablo@docubrain.app"},
        gives_anyone_access=False,
    ),
    ExternalUserGroupSet(
    ...
    ExternalUserGroupSet(
        ...
        user_emails={"founders@docubrain.app"},  # no Oauth, we skip "app" account in jira
        gives_anyone_access=False,
    ),
    ExternalUserGroupSet(
