...
from ee.docubrain.external_permissions.confluence.group_sync import confluence_group_sync
...
_EXPECTED_CONFLUENCE_GROUPS = [
    ExternalUserGroupSet(
        ...
        user_emails={"chris@docubrain.app", "yuhong@docubrain.app"},
        gives_anyone_access=False,
    ),
    ExternalUserGroupSet(
        id="org-admins",
        user_emails={
            "founders@docubrain.app",
            "chris@docubrain.app",
            "yuhong@docubrain.app",
            "oauth@docubrain.app",
        },
        gives_anyone_access=False,
    ),
    ...
    ExternalUserGroupSet(
        ...
        user_emails={"hagen@danswer.ai", "founders@docubrain.app", "pablo@docubrain.app"},
        gives_anyone_access=False,
    ),
    ExternalUserGroupSet(
    ...
    ExternalUserGroupSet(
        ...
        user_emails={"yuhong@docubrain.app"},
        gives_anyone_access=False,
    ),
    ExternalUserGroupSet(
        id="All_Confluence_Users_Found_By_Docubrain",
        user_emails={
            "chris@docubrain.app",
            "founders@docubrain.app",
            "hagen@danswer.ai",
    ...
    ExternalUserGroupSet(
        id="bitbucket-users-docubrainai",
        user_emails={"founders@docubrain.app", "oauth@docubrain.app"},
        gives_anyone_access=False,
    ),
    ExternalUserGroupSet(
        id="bitbucket-admins-docubrainai",
        user_emails={"founders@docubrain.app", "oauth@docubrain.app"},
        gives_anyone_access=False,
    ),
    ExternalUserGroupSet(
        id="jira-servicemanagement-users-danswerai",
        user_emails={"oauth@docubrain.app"},
        gives_anyone_access=False,
    ),
    ExternalUserGroupSet(
        id="no yuhong allowed",
        user_emails={"hagen@danswer.ai", "pablo@docubrain.app", "chris@docubrain.app"},
        gives_anyone_access=False,
    ),
]
