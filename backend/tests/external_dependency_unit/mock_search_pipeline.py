...
def use_mock_search_pipeline(
    ...
    with (
        patch(
            "docubrain.tools.tool_implementations.search.search_tool.search_pipeline",
            new=override_search_pipeline,
        ),
        patch(
            "docubrain.tools.tool_implementations.search.search_tool.check_connectors_exist",
            new=mock_check_connectors_exist,
        ),
        patch(
            "docubrain.tools.tool_implementations.search.search_tool.check_federated_connectors_exist",
            new=mock_check_federated_connectors_exist,
        ),
        patch(
            "docubrain.tools.tool_implementations.search.search_tool.semantic_query_rephrase",
            return_value="",
        ),
        patch(
            "docubrain.tools.tool_implementations.search.search_tool.keyword_query_expansion",
            return_value=[],
        ),
        patch(
            "docubrain.tools.tool_runner.run_functions_tuples_in_parallel",
            new=run_functions_tuples_sequential,
        ),
        patch(
            "docubrain.db.connector.check_connectors_exist",
            new=mock_check_connectors_exist,
        ),
        patch(
            "docubrain.db.connector.check_federated_connectors_exist",
            new=mock_check_federated_connectors_exist,
        ),
        patch(
            "docubrain.db.connector.check_user_files_exist",
            new=mock_check_user_files_exist,
        ),
        patch(
            "docubrain.db.connector.fetch_unique_document_sources",
            new=mock_fetch_unique_document_sources,
        ),
        # Mock the pre-fetch phase of SearchTool.run()
        patch(
            "docubrain.tools.tool_implementations.search.search_tool.get_session_with_current_tenant",
            new=mock_get_session,
        ),
        patch(
            "docubrain.tools.tool_implementations.search.search_tool.build_access_filters_for_user",
            return_value=[],
        ),
        patch(
            "docubrain.tools.tool_implementations.search.search_tool.get_current_search_settings",
            return_value=MagicMock(spec=SearchSettings),
        ),
        patch(
            "docubrain.tools.tool_implementations.search.search_tool.EmbeddingModel.from_db_model",
            return_value=MagicMock(spec=EmbeddingModel),
        ),
        patch(
            "docubrain.tools.tool_implementations.search.search_tool.get_federated_retrieval_functions",
            return_value=[],
        ),
        patch.object(
            SearchTool,
