...
from docubrain.db.models import Tag
from docubrain.db.tag import create_or_add_document_tag
from docubrain.db.tag import create_or_add_document_tag_list
