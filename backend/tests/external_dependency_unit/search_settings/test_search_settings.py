...
from docubrain.db.llm import fetch_default_contextual_rag_model
...
from docubrain.indexing.indexing_pipeline import IndexingPipelineResult
...
from docubrain.server.manage.search_settings import set_new_search_settings
from docubrain.server.manage.search_settings import update_saved_search_settings
...
@patch("docubrain.db.swap_index.get_all_document_indices")
@patch("docubrain.server.manage.search_settings.get_all_document_indices")
@patch("docubrain.server.manage.search_settings.get_default_document_index")
@patch("docubrain.indexing.indexing_pipeline.get_llm_for_contextual_rag")
@patch("docubrain.indexing.indexing_pipeline.index_doc_batch_with_handler")
