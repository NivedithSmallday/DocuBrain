...
from docubrain.db.llm import fetch_auto_mode_providers
...
from docubrain.db.llm import fetch_llm_provider_view
...
from docubrain.llm.well_known_providers.auto_update_models import LLMProviderRecommendation
from docubrain.llm.well_known_providers.auto_update_models import LLMRecommendations
from docubrain.llm.well_known_providers.models import SimpleKnownModel
from docubrain.server.manage.llm.api import put_llm_provider
from docubrain.server.manage.llm.api import (
...
class TestAutoModeSyncFeature:
    ...
    def test_auto_mode_syncs_models_from_github_config(
        ...
        try:
            with patch(
                "docubrain.server.manage.llm.api.fetch_llm_recommendations_from_github",
    ...
    def test_switching_default_between_auto_mode_providers(
        ...
        try:
            ...
            with patch(
                "docubrain.server.manage.llm.api.test_llm", side_effect=mock_test_llm_capture
            ):
