...
def _test_jira_connector_basic(jira_connector: JiraConnector) -> None:
    ...
    assert story.metadata == {
        ...
        "reporter_email": "chris@docubrain.app",
        "assignee_email": "chris@docubrain.app",
    ...
    assert (
        section.text
        == "This is a critical request for super-human answer quality in DocuBrain! We need magic!\n"
    )
    ...
    assert epic.metadata == {
        "priority": "Medium",
        "status": "Backlog",
        "reporter": "Founder DocuBrain",
        "assignee": "Chris Weaver",
        "issuetype": "Epic",
        "created": "2025-04-16T16:55:53.068-0700",
        "reporter_email": "founders@docubrain.app",
        "assignee_email": "chris@docubrain.app",
        "project_name": "DailyConnectorTestProject",
        "project": "AS",
        "key": "AS-4",
