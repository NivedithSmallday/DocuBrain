...
from docubrain.connectors.gmail.connector import GmailConnector
...
from tests.unit.docubrain.connectors.utils import load_everything_from_checkpoint_connector
...
This thread was 4 emails long:
    admin@docubrain-test.com -> test-group-1@docubrain-test.com (conaining test_user_1 and test_user_2)
    test_user_1@docubrain-test.com -> admin@docubrain-test.com
    admin@docubrain-test.com -> test_user_2@docubrain-test.com + BCC: test_user_3@docubrain-test.com
    test_user_3@docubrain-test.com -> admin@docubrain-test.com
"""
_THREAD_1_BY_ID: dict[str, dict[str, Any]] = {
    "192edefb315737c3": {
        "email": "admin@docubrain-test.com",
        "sections_count": 4,
        "primary_owners": set(
            [
                "admin@docubrain-test.com",
                "test_user_1@docubrain-test.com",
                "test_user_3@docubrain-test.com",
            ]
        ),
        "secondary_owners": set(
            [
                "test-group-1@docubrain-test.com",
                "admin@docubrain-test.com",
                "test_user_2@docubrain-test.com",
                "test_user_3@docubrain-test.com",
            ]
        ),
    },
    "192edf020d2f5def": {
        "email": "test_user_1@docubrain-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@docubrain-test.com", "test_user_1@docubrain-test.com"]),
        "secondary_owners": set(["test-group-1@docubrain-test.com", "admin@docubrain-test.com"]),
    },
    "192edf020ae90aab": {
        "email": "test_user_2@docubrain-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@docubrain-test.com"]),
        "secondary_owners": set(
            ["test-group-1@docubrain-test.com", "test_user_2@docubrain-test.com"]
        ),
    },
    "192edf18316015fa": {
        "email": "test_user_3@docubrain-test.com",
        "sections_count": 2,
        "primary_owners": set(["admin@docubrain-test.com", "test_user_3@docubrain-test.com"]),
        "secondary_owners": set(
            [
                "admin@docubrain-test.com",
                "test_user_2@docubrain-test.com",
...
@patch(
    "docubrain.file_processing.extract_file_text.get_unstructured_api_key",
    return_value=None,
)
