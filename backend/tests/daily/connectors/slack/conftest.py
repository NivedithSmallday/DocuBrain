...
from docubrain.connectors.slack.connector import SlackConnector
...
def slack_connector(
    ...
    slack_credentials_provider: DocubrainStaticCredentialsProvider,
...
@pytest.fixture
def slack_credentials_provider() -> DocubrainStaticCredentialsProvider:
    CI_ENV_VAR = "SLACK_BOT_TOKEN"
    LOCAL_ENV_VAR = "DOCUBRAIN_BOT_SLACK_BOT_TOKEN"
    ...
    return DocubrainStaticCredentialsProvider(
