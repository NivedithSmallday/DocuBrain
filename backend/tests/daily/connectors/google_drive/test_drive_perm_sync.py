...
from ee.docubrain.external_permissions.google_drive.doc_sync import gdrive_doc_sync
from ee.docubrain.external_permissions.google_drive.group_sync import gdrive_group_sync
from docubrain.access.models import DocExternalAccess
from docubrain.connectors.google_drive.connector import GoogleDriveConnector
...
def test_gdrive_perm_sync_with_real_data(
    ...
    with patch(
        "ee.docubrain.external_permissions.google_drive.doc_sync.GoogleDriveConnector",
    ...
    with patch(
        "ee.docubrain.external_permissions.google_drive.group_sync.GoogleDriveConnector",
        return_value=_build_connector(google_drive_service_acct_connector_factory),
    ):
