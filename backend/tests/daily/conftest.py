...
# TODO(Nik): https://linear.app/docubrain-app/issue/ENG-1/update-test-infra-to-use-test-license
...
from docubrain.auth.users import current_user
...
from docubrain.main import get_application
...
def client() -> Generator[TestClient, None, None]:
    ...
    with patch("docubrain.main.setup_prometheus_metrics"):
