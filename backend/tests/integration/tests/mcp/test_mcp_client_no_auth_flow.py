...
# NOTE: the tests for client should be independent of the DocuBrain MCP server
# This means the port should probably stay to be 8010/not 8090 the DocuBrain MCP server port
# Use MOCK_MCP_SERVER_PORT to avoid conflicts with the real DocuBrain MCP server port (8090)
