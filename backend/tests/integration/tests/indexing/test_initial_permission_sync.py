...
from docubrain.connectors.mock_connector.connector import EXTERNAL_USER_EMAILS
from docubrain.connectors.mock_connector.connector import EXTERNAL_USER_GROUP_IDS
from docubrain.connectors.mock_connector.connector import MockConnectorCheckpoint
