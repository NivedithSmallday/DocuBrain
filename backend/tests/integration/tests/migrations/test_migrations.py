...
def test_anonymous_user_migration_dedupes_null_notifications() -> None:
            ...
            text(
                ...
                VALUES
                    (
                        ...
                        NOW(),
                        NOW(),
                        'DocuBrain v2.10.0 is available!',
                        'Check out what''s new in v2.10.0',
                        '{"version":"v2.10.0","link":"https://docs.docubrain.app/changelog#v2-10-0"}'::jsonb
                    ),
                    (
                        2,
                        'RELEASE_NOTES',
    ...
    assert anonymous_user.email == "anonymous@docubrain.app"
    ...
    with get_session_with_current_tenant() as db_session:
        ...
        db_session.execute(
            text(
                ...
                VALUES (:id, 'anonymous@docubrain.app', '', TRUE, FALSE, TRUE, 'LIMITED')
