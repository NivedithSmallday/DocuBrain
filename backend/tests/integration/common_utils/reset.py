...
from docubrain.configs.app_configs import POSTGRES_HOST
from docubrain.configs.app_configs import POSTGRES_PASSWORD
from docubrain.configs.app_configs import POSTGRES_PORT
from docubrain.configs.app_configs import POSTGRES_USER
from docubrain.db.engine.sql_engine import build_connection_string
...
from docubrain.db.engine.sql_engine import SYNC_DB_API
...
from docubrain.document_index.document_index_utils import get_multipass_config
from docubrain.document_index.vespa.index import DOCUMENT_ID_ENDPOINT
...
from docubrain.setup import setup_document_indices
from docubrain.setup import setup_postgres
...
def reset_postgres_multitenant() -> None:
    ...
    reset_postgres(config_name="schema_private", setup_docubrain=False)
