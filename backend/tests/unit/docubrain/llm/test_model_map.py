...
from docubrain.llm.utils import find_model_obj
from docubrain.llm.utils import get_model_map
...
def test_no_overwrite_in_model_map() -> None:
    ...
    # Create a mock model_cost dict with multiple entries for "docubrain-llm"
