...
from docubrain.access.access import collect_user_file_access
from docubrain.access.access import get_access_for_user_files_impl
...
class TestGetAccessForUserFiles:
    def test_shared_user_in_acl(self) -> None:
        ...
        with patch(
            "docubrain.access.access.fetch_user_files_with_access_relationships",
            return_value=[uf],
        ):
