...
from docubrain.voice.providers.openai import _create_wav_header
from docubrain.voice.providers.openai import _http_to_ws_url
from docubrain.voice.providers.openai import OpenAIRealtimeMessageType
