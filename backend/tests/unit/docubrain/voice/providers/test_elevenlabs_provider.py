...
from docubrain.voice.providers.elevenlabs import _http_to_ws_url
from docubrain.voice.providers.elevenlabs import DEFAULT_ELEVENLABS_API_BASE
from docubrain.voice.providers.elevenlabs import ElevenLabsSTTMessageType
from docubrain.voice.providers.elevenlabs import ElevenLabsVoiceProvider
...
def test_resample_pcm16_passthrough_when_same_rate() -> None:
    from docubrain.voice.providers.elevenlabs import ElevenLabsStreamingTranscriber
