...
from docubrain.hooks import registry as registry_module
from docubrain.hooks.registry import get_all_specs
from docubrain.hooks.registry import get_hook_point_spec
