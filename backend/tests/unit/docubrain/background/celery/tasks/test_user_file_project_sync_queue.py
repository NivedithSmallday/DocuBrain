...
@patch(
    "docubrain.background.celery.tasks.user_file_processing.tasks.get_user_file_project_sync_queue_depth"
)
@patch("docubrain.background.celery.tasks.user_file_processing.tasks.get_redis_client")
...
@patch(
    "docubrain.background.celery.tasks.user_file_processing.tasks.enqueue_user_file_project_sync_task"
)
@patch(
    "docubrain.background.celery.tasks.user_file_processing.tasks.get_user_file_project_sync_queue_depth"
)
@patch(
    "docubrain.background.celery.tasks.user_file_processing.tasks.get_session_with_current_tenant"
)
@patch("docubrain.background.celery.tasks.user_file_processing.tasks.get_redis_client")
