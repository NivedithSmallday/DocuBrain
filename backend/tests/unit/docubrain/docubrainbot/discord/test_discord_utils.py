...
class TestGetBotToken:
    ...
    def test_get_token_from_env(self) -> None:
        ...
        with patch("docubrain.docubrainbot.discord.utils.DISCORD_BOT_TOKEN", "env_token_123"):
    ...
    def test_get_token_from_db(self) -> None:
        ...
        with (
            patch("docubrain.docubrainbot.discord.utils.DISCORD_BOT_TOKEN", None),
            patch("docubrain.docubrainbot.discord.utils.AUTH_TYPE", "basic"),  # Not CLOUD
            patch("docubrain.docubrainbot.discord.utils.get_session_with_tenant") as mock_session,
            patch(
                "docubrain.docubrainbot.discord.utils.get_discord_bot_config",
    ...
    def test_get_token_env_priority(self) -> None:
        ...
        with (
            patch("docubrain.docubrainbot.discord.utils.DISCORD_BOT_TOKEN", "env_token_123"),
            patch(
                "docubrain.docubrainbot.discord.utils.get_discord_bot_config",
                return_value=mock_config,
            ),
