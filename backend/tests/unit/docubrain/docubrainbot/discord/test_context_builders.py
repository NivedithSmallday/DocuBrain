...
from docubrain.docubrainbot.discord.handle_message import _build_conversation_context
from docubrain.docubrainbot.discord.handle_message import _build_reply_chain_context
from docubrain.docubrainbot.discord.handle_message import _build_thread_context
from docubrain.docubrainbot.discord.handle_message import _format_messages_as_context
from docubrain.docubrainbot.discord.handle_message import format_message_content
from tests.unit.docubrain.docubrainbot.discord.conftest import AsyncIteratorMock
from tests.unit.docubrain.docubrainbot.discord.conftest import mock_message
    ...
    async def test_build_thread_context_includes_bot_messages(
        ...
        messages = [
            ...
            mock_message(
                ...
                author_display_name="DocubrainBot",
            ),
        ]
...
class TestContextFormatting:
    ...
    def test_context_format_bot_marker(self, mock_bot_user: MagicMock) -> None:
        """Bot messages in context are marked as DocubrainBot:."""
        msg = mock_message(
            content="Bot response",
            author_bot=True,
            author_id=mock_bot_user.id,
