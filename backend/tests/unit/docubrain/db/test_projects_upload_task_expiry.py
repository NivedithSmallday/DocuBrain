...
@patch("docubrain.db.projects.get_current_tenant_id", return_value="test_tenant")
@patch("docubrain.db.projects.create_user_files")
@patch(
    "docubrain.background.celery.versioned_apps.client.app",
