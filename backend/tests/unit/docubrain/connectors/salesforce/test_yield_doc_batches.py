...
from docubrain.connectors.salesforce.connector import _convert_to_metadata_value
from docubrain.connectors.salesforce.connector import SalesforceConnector
from docubrain.connectors.salesforce.utils import ID_FIELD
from docubrain.connectors.salesforce.utils import MODIFIED_FIELD
from docubrain.connectors.salesforce.utils import NAME_FIELD
from docubrain.connectors.salesforce.utils import SalesforceObject
...
class TestYieldDocBatches:
    ...
    def mock_sf_db(self) -> MagicMock:
        """Create a mock DocubrainSalesforceSQLite object."""
        return MagicMock()
    ...
    @patch("docubrain.connectors.salesforce.connector.convert_sf_object_to_doc")
