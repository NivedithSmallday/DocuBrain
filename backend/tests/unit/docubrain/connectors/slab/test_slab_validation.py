...
from docubrain.connectors.slab.connector import SlabConnector
...
@patch("docubrain.connectors.slab.connector.get_all_post_ids", return_value=["id1"])
...
@patch(
    "docubrain.connectors.slab.connector.get_all_post_ids",
