...
from docubrain.connectors.discord.connector import DiscordConnector
from docubrain.connectors.exceptions import CredentialInvalidError
...
@patch("docubrain.connectors.discord.connector.Client.close", new_callable=AsyncMock)
@patch("docubrain.connectors.discord.connector.Client.login", new_callable=AsyncMock)
...
@patch("docubrain.connectors.discord.connector.Client.close", new_callable=AsyncMock)
@patch(
    "docubrain.connectors.discord.connector.Client.login",
