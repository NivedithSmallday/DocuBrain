...
from docubrain.connectors.sharepoint.connector import _REST_CTX_MAX_AGE_S
...
@patch("docubrain.connectors.sharepoint.connector.acquire_token_for_rest")
@patch("docubrain.connectors.sharepoint.connector.ClientContext")
...
@patch("docubrain.connectors.sharepoint.connector.time")
@patch("docubrain.connectors.sharepoint.connector.acquire_token_for_rest")
@patch("docubrain.connectors.sharepoint.connector.ClientContext")
