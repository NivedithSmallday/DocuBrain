...
from docubrain.connectors.sharepoint.connector import DriveItemData
from docubrain.connectors.sharepoint.connector import SHARED_DOCUMENTS_MAP
from docubrain.connectors.sharepoint.connector import SharepointConnector
from docubrain.connectors.sharepoint.connector import SharepointConnectorCheckpoint
from docubrain.connectors.sharepoint.connector import SiteDescriptor
...
def test_load_from_checkpoint_maps_drive_name(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "docubrain.connectors.sharepoint.connector._convert_driveitem_to_document_with_permissions",
        fake_convert,
    )
    monkeypatch.setattr(
        SharepointConnector,
