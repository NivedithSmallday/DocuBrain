...
from docubrain.connectors.zendesk.connector import ZendeskClient
from docubrain.connectors.zendesk.connector import ZendeskConnector
...
def test_load_from_checkpoint_with_rate_limit(
    ...
    with patch("docubrain.connectors.zendesk.connector.requests.get") as mock_get:
        ...
        # Call load_from_checkpoint
        end_time = time.time()
        with patch("docubrain.connectors.zendesk.connector.time.sleep") as mock_sleep:
