...
Run with: mypy tests/unit/docubrain/utils/test_sensitive_typing.py --ignore-missing-imports
...
def demonstrate_correct_usage() -> None:
    ...
    from docubrain.utils.encryption import encrypt_string_to_bytes, decrypt_bytes_to_string
