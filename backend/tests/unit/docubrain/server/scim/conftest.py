...
from ee.docubrain.server.scim.models import ScimListResponse
...
from docubrain.db.models import ScimToken
...
def mock_dal() -> Generator[MagicMock, None, None]:
    ...
    with patch("ee.docubrain.server.scim.api.ScimDAL") as cls:
