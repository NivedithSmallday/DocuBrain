...
from ee.docubrain.server.scim.api import create_group
from ee.docubrain.server.scim.api import delete_group
...
from ee.docubrain.server.scim.api import replace_group
...
from tests.unit.docubrain.server.scim.conftest import make_scim_group
...
class TestCreateGroup:
    ...
    @patch("ee.docubrain.server.scim.api._validate_and_parse_members")
    def test_success(
        self,
