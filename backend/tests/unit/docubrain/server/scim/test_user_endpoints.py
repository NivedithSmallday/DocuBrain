...
from ee.docubrain.server.scim.api import _scim_name_to_str
...
from ee.docubrain.server.scim.patch import ScimPatchError
from ee.docubrain.server.scim.providers.base import ScimProvider
from tests.unit.docubrain.server.scim.conftest import assert_scim_error
...
class TestCreateUser:
    ...
    @patch("ee.docubrain.server.scim.api._check_seat_availability")
...
class TestPatchUser:
    ...
    @patch("ee.docubrain.server.scim.api.apply_user_patch")
