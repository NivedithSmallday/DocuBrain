...
from ee.docubrain.server.scim.api import create_user
from ee.docubrain.server.scim.api import delete_user
from ee.docubrain.server.scim.api import get_group
from ee.docubrain.server.scim.api import get_resource_types
from ee.docubrain.server.scim.api import get_schemas
from ee.docubrain.server.scim.api import get_service_provider_config
from ee.docubrain.server.scim.api import get_user
from ee.docubrain.server.scim.api import list_groups
from ee.docubrain.server.scim.api import list_users
from ee.docubrain.server.scim.api import patch_group
from ee.docubrain.server.scim.api import patch_user
from ee.docubrain.server.scim.api import replace_user
from ee.docubrain.server.scim.api import ScimJSONResponse
from ee.docubrain.server.scim.models import SCIM_ENTERPRISE_USER_SCHEMA
from ee.docubrain.server.scim.models import SCIM_USER_SCHEMA
from ee.docubrain.server.scim.models import ScimEnterpriseExtension
from ee.docubrain.server.scim.models import ScimGroupMember
from ee.docubrain.server.scim.models import ScimGroupResource
from ee.docubrain.server.scim.models import ScimManagerRef
from ee.docubrain.server.scim.models import ScimMappingFields
from ee.docubrain.server.scim.models import ScimName
from ee.docubrain.server.scim.models import ScimPatchOperation
from ee.docubrain.server.scim.models import ScimPatchOperationType
from ee.docubrain.server.scim.models import ScimPatchRequest
from ee.docubrain.server.scim.models import ScimPatchResourceValue
from ee.docubrain.server.scim.models import ScimUserResource
from ee.docubrain.server.scim.providers.base import ScimProvider
from ee.docubrain.server.scim.providers.entra import EntraProvider
from tests.unit.docubrain.server.scim.conftest import make_db_group
from tests.unit.docubrain.server.scim.conftest import make_db_user
from tests.unit.docubrain.server.scim.conftest import make_scim_user
from tests.unit.docubrain.server.scim.conftest import make_user_mapping
from tests.unit.docubrain.server.scim.conftest import parse_scim_group
from tests.unit.docubrain.server.scim.conftest import parse_scim_list
from tests.unit.docubrain.server.scim.conftest import parse_scim_user
...
class TestEntraUserLifecycle:
    ...
    @patch("ee.docubrain.server.scim.api._check_seat_availability", return_value=None)
    ...
    def test_name_formatted_preserved_on_create(
        ...
        with patch(
            "ee.docubrain.server.scim.api._check_seat_availability", return_value=None
        ):
            result = create_user(
                user_resource=resource,
                _token=mock_token,
...
class TestEntraGroupLifecycle:
    ...
    @patch("ee.docubrain.server.scim.api.apply_group_patch")
