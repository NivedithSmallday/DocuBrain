...
from ee.docubrain.server.scim.models import ScimUserGroupRef
from ee.docubrain.server.scim.models import ScimUserResource
from ee.docubrain.server.scim.providers.base import COMMON_IGNORED_PATCH_PATHS
from ee.docubrain.server.scim.providers.base import get_default_provider
from ee.docubrain.server.scim.providers.entra import _ENTRA_IGNORED_PATCH_PATHS
