...
<parameter name="queries" string="false">["DocuBrain documentation", "DocuBrain docs", "DocuBrain platform"]</parameter>
</invoke>
</function_calls>
"""
        tool_calls = extract_tool_calls_from_response_text(
...
<parameter name="queries" string="false">["DocuBrain docs"]</parameter>
</invoke>
</function_calls>
"""
        tool_calls = extract_tool_calls_from_response_text(
...
class TestXmlToolCallContentFilter:
    ...
    def test_strips_function_calls_block_split_across_chunks(self) -> None:
        ...
        chunks = [
            ...
            '<parameter name="queries" string="false">["DocuBrain docs"]',
