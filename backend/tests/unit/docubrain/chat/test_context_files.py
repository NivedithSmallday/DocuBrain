...
from docubrain.chat.process_message import determine_search_params
from docubrain.chat.process_message import extract_context_files
from docubrain.chat.process_message import resolve_context_user_files
...
class TestResolveContextUserFiles:
    ...
    @patch("docubrain.chat.process_message.get_user_files_from_project")
...
class TestExtractContextFiles:
    ...
    @patch("docubrain.chat.process_message.load_in_memory_chat_files")
    ...
    @patch("docubrain.chat.process_message.DISABLE_VECTOR_DB", True)
