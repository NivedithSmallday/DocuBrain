...
from docubrain.chat.compression import _build_llm_messages_for_summarization
from docubrain.chat.compression import find_summary_for_branch
from docubrain.chat.compression import generate_summary
from docubrain.chat.compression import get_compression_params
from docubrain.chat.compression import get_messages_to_summarize
from docubrain.chat.compression import SummaryContent
...
from docubrain.prompts.compression_prompts import PROGRESSIVE_SUMMARY_SYSTEM_PROMPT_BLOCK
from docubrain.prompts.compression_prompts import PROGRESSIVE_USER_REMINDER
from docubrain.prompts.compression_prompts import SUMMARIZATION_CUTOFF_MARKER
from docubrain.prompts.compression_prompts import SUMMARIZATION_PROMPT
from docubrain.prompts.compression_prompts import USER_REMINDER
...
def test_generate_summary_initial_system_prompt() -> None:
    ...
    with patch("docubrain.chat.compression.llm_generation_span"):
