...
from docubrain.cache.interface import CacheLock
...
from docubrain.chat.stop_signal_checker import FENCE_TTL
from docubrain.chat.stop_signal_checker import is_connected
