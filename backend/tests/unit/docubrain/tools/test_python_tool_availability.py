...
TOOL_MODULE = "docubrain.tools.tool_implementations.python.python_tool"
CLIENT_MODULE = "docubrain.tools.tool_implementations.python.code_interpreter_client"
...
def test_health_check_cached_on_second_call() -> None:
    from docubrain.tools.tool_implementations.python.code_interpreter_client import (
