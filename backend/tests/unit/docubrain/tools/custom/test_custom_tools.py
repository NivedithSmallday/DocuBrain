...
from docubrain.tools.tool_implementations.custom.custom_tool import CustomToolCallSummary
from docubrain.tools.tool_implementations.custom.custom_tool import (
...
class TestCustomTool(unittest.TestCase):
    ...
    @patch("docubrain.tools.tool_implementations.custom.custom_tool.requests.request")
