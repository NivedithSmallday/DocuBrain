...
from docubrain.tools.tool_implementations.file_reader.file_reader_tool import FILE_ID_FIELD
from docubrain.tools.tool_implementations.file_reader.file_reader_tool import FileReaderTool
from docubrain.tools.tool_implementations.file_reader.file_reader_tool import MAX_NUM_CHARS
from docubrain.tools.tool_implementations.file_reader.file_reader_tool import NUM_CHARS_FIELD
from docubrain.tools.tool_implementations.file_reader.file_reader_tool import (
    START_CHAR_FIELD,
)

TOOL_MODULE = "docubrain.tools.tool_implementations.file_reader.file_reader_tool"
