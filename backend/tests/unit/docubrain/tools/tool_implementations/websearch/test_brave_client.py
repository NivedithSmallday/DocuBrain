...
import docubrain.tools.tool_implementations.web_search.clients.brave_client as brave_module
from docubrain.tools.tool_implementations.web_search.clients.brave_client import (
    BraveClient,
)
...
def test_search_maps_brave_response(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    results = client.search("docubrain")
