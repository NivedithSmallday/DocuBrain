...
from ee.docubrain.utils.license import get_license_status
from ee.docubrain.utils.license import is_license_valid
from ee.docubrain.utils.license import verify_license_signature
...
class TestVerifyLicenseSignature:
    ...
    def test_valid_signature(self) -> None:
        ...
        with patch("ee.docubrain.utils.license._get_public_key", return_value=public_key):
    ...
    def test_invalid_signature(self) -> None:
        ...
        with patch(
            "ee.docubrain.utils.license._get_public_key",
