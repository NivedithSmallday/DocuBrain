...
from ee.docubrain.external_permissions.sharepoint.permission_utils import (
...
from ee.docubrain.external_permissions.sharepoint.permission_utils import GroupsResult


MODULE = "ee.docubrain.external_permissions.sharepoint.permission_utils"
