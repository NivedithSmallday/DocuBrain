...
from ee.docubrain.db.license import delete_license
from ee.docubrain.db.license import get_license
from ee.docubrain.db.license import upsert_license
from ee.docubrain.server.license.models import LicenseMetadata
from ee.docubrain.server.license.models import LicenseSource
from ee.docubrain.server.license.models import PlanType
from docubrain.db.models import License
...
class TestCheckSeatAvailabilitySelfHosted:
    ...
    @patch("ee.docubrain.db.license.get_license_metadata", return_value=None)
    ...
    @patch("ee.docubrain.db.license.get_used_seats", return_value=5)
    @patch("ee.docubrain.db.license.get_license_metadata")
    ...
    @patch("ee.docubrain.db.license.get_used_seats", return_value=10)
    @patch("ee.docubrain.db.license.get_license_metadata")
    ...
    @patch("ee.docubrain.db.license.get_used_seats", return_value=9)
    @patch("ee.docubrain.db.license.get_license_metadata")
...
class TestCheckSeatAvailabilityMultiTenant:
    ...
    @patch("ee.docubrain.db.license.MULTI_TENANT", True)
    @patch(
        "ee.docubrain.server.tenants.user_mapping.get_tenant_count",
        return_value=5,
    )
    @patch("ee.docubrain.db.license.get_license_metadata")
