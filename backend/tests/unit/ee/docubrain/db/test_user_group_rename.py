...
from ee.docubrain.db.user_group import rename_user_group
...
class TestRenameUserGroup:
    ...
    @patch("ee.docubrain.db.user_group.DISABLE_VECTOR_DB", False)
    @patch(
        "ee.docubrain.db.user_group._mark_user_group__cc_pair_relationships_outdated__no_commit"
    )
