...
from docubrain.prompts.chat_prompts import ADDITIONAL_INFO
from docubrain.prompts.chat_prompts import CITATION_GUIDANCE_REPLACEMENT_PAT
from docubrain.prompts.chat_prompts import COMPANY_DESCRIPTION_BLOCK
from docubrain.prompts.chat_prompts import COMPANY_NAME_BLOCK
from docubrain.prompts.chat_prompts import DATETIME_REPLACEMENT_PAT
from docubrain.prompts.chat_prompts import REMINDER_TAG_REPLACEMENT_PAT
from docubrain.prompts.chat_prompts import REQUIRE_CITATION_GUIDANCE
from docubrain.prompts.constants import CODE_BLOCK_PAT
from docubrain.prompts.constants import REMINDER_TAG_DESCRIPTION
...
def handle_docubrain_date_awareness(
    prompt_str: str,
