...
from docubrain.configs.constants import DocubrainCallTypes
from docubrain.configs.kg_configs import KG_METADATA_TRACKING_THRESHOLD
from docubrain.db.engine.sql_engine import get_session_with_current_tenant
from docubrain.db.entities import get_kg_entity_by_document
from docubrain.db.entity_type import get_entity_types
from docubrain.db.kg_config import KGConfigSettings
...
from docubrain.db.tag import get_structured_tags_for_document
from docubrain.kg.models import KGAttributeEntityOption
from docubrain.kg.models import KGAttributeTrackInfo
from docubrain.kg.models import KGAttributeTrackType
from docubrain.kg.models import KGChunkFormat
from docubrain.kg.models import KGClassificationInstructions
from docubrain.kg.models import KGClassificationResult
...
from docubrain.kg.models import KGMetadataContent
from docubrain.kg.utils.formatting_utils import extract_email
from docubrain.kg.utils.formatting_utils import get_entity_type
from docubrain.kg.utils.formatting_utils import kg_email_processing
from docubrain.kg.utils.formatting_utils import make_entity_id
from docubrain.kg.utils.formatting_utils import make_relationship_id
from docubrain.kg.utils.formatting_utils import make_relationship_type_id
from docubrain.kg.vespa.vespa_interactions import get_document_vespa_contents
...
from docubrain.prompts.kg_prompts import CALL_CHUNK_PREPROCESSING_PROMPT
from docubrain.prompts.kg_prompts import CALL_DOCUMENT_CLASSIFICATION_PROMPT
from docubrain.prompts.kg_prompts import GENERAL_CHUNK_PREPROCESSING_PROMPT
from docubrain.prompts.kg_prompts import MASTER_EXTRACTION_PROMPT
...
def kg_implied_extraction(
    ...
    document_is_from_call = document_entity_type.lower() in (
        call_type.value.lower() for call_type in DocubrainCallTypes
    )
...
def kg_classify_document(
    ...
    if entity_type not in (call_type.value for call_type in DocubrainCallTypes):
        return None
...
def kg_deep_extract_chunks(
    ...
    entity_type = get_entity_type(document_entity)
    is_call = entity_type in (call_type.value for call_type in DocubrainCallTypes)
