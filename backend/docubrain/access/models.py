...
from docubrain.access.utils import prefix_user_group
...
class ExternalAccess:
    ...
    # Whether the document is public in the external system or DocuBrain
    is_public: bool
...
class DocumentAccess(ExternalAccess):
    # User emails for DocuBrain users, None indicates admin
