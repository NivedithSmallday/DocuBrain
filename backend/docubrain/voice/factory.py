...
from docubrain.voice.interface import VoiceProviderInterface
...
def get_voice_provider(provider: VoiceProvider) -> VoiceProviderInterface:
    ...
    if provider_type == "openai":
        from docubrain.voice.providers.openai import OpenAIVoiceProvider
        ...
        from docubrain.voice.providers.azure import AzureVoiceProvider
