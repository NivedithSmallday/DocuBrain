# Overview of DocuBrain Background Jobs
...
Watchdog is a separate Python process managed by supervisord which runs alongside celery workers. It checks the DOCUBRAIN_CELERY_BEAT_HEARTBEAT_KEY in
