...
from docubrain.configs.constants import POSTGRES_CELERY_WORKER_DOCPROCESSING_APP_NAME
from docubrain.db.engine.sql_engine import SqlEngine
from docubrain.server.metrics.celery_task_metrics import on_celery_task_postrun
from docubrain.server.metrics.celery_task_metrics import on_celery_task_prerun
from docubrain.server.metrics.celery_task_metrics import on_celery_task_rejected
from docubrain.server.metrics.celery_task_metrics import on_celery_task_retry
from docubrain.server.metrics.celery_task_metrics import on_celery_task_revoked
...
celery_app.config_from_object("docubrain.background.celery.configs.docprocessing")
