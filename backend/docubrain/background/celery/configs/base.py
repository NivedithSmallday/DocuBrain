...
from docubrain.configs.app_configs import CELERY_BROKER_POOL_LIMIT
from docubrain.configs.app_configs import CELERY_RESULT_EXPIRES
from docubrain.configs.app_configs import REDIS_DB_NUMBER_CELERY
from docubrain.configs.app_configs import REDIS_DB_NUMBER_CELERY_RESULT_BACKEND
...
broker_transport_options = {
    "priority_steps": list(range(len(DocubrainCeleryPriority))),
...
task_default_priority = DocubrainCeleryPriority.MEDIUM
task_acks_late = True
