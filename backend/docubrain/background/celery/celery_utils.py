...
from docubrain.configs.app_configs import MAX_PRUNING_DOCUMENT_RETRIEVAL_PER_MINUTE
from docubrain.configs.app_configs import VESPA_REQUEST_TIMEOUT
from docubrain.connectors.connector_runner import CheckpointOutputWrapper
from docubrain.connectors.cross_connector_utils.rate_limit_wrapper import (
    rate_limit_builder,
)
from docubrain.connectors.interfaces import BaseConnector
...
from docubrain.connectors.interfaces import LoadConnector
from docubrain.connectors.interfaces import PollConnector
from docubrain.connectors.interfaces import SlimConnector
...
from docubrain.server.metrics.pruning_metrics import inc_pruning_rate_limit_error
from docubrain.server.metrics.pruning_metrics import observe_pruning_enumeration_duration
...
def make_probe_path(probe: str, hostname: str) -> Path:
    ...
    e.g. /tmp/docubrain_k8s_indexing_readiness.txt
    """
    ...
    return Path(f"/tmp/docubrain_k8s_{safe_name}_{probe}.txt")
