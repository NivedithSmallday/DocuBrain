...
from docubrain.access.access import get_access_for_document
...
from docubrain.background.celery.tasks.shared.tasks import LIGHT_SOFT_TIME_LIMIT
from docubrain.background.celery.tasks.shared.tasks import LIGHT_TIME_LIMIT
from docubrain.background.celery.tasks.shared.tasks import DocubrainCeleryTaskCompletionStatus
from docubrain.background.celery.tasks.vespa.document_sync import DOCUMENT_SYNC_FENCE_KEY
from docubrain.background.celery.tasks.vespa.document_sync import get_document_sync_payload
from docubrain.background.celery.tasks.vespa.document_sync import get_document_sync_remaining
from docubrain.background.celery.tasks.vespa.document_sync import reset_document_sync
from docubrain.background.celery.tasks.vespa.document_sync import (
    try_generate_stale_document_sync_tasks,
)
from docubrain.configs.app_configs import JOB_TIMEOUT
from docubrain.configs.app_configs import VESPA_SYNC_MAX_TASKS
from docubrain.configs.constants import CELERY_VESPA_SYNC_BEAT_LOCK_TIMEOUT
...
from docubrain.db.document import get_document
from docubrain.db.document import mark_document_as_synced
from docubrain.db.document_set import delete_document_set
from docubrain.db.document_set import fetch_document_sets
from docubrain.db.document_set import fetch_document_sets_for_document
from docubrain.db.document_set import get_document_set_by_id
from docubrain.db.document_set import mark_document_set_as_synced
...
from docubrain.db.sync_record import cleanup_sync_records
...
from docubrain.utils.variable_functionality import noop_fallback
...
@shared_task(
    name=DocubrainCeleryTask.CHECK_FOR_VESPA_SYNC_TASK,
    ignore_result=True,
...
def check_for_vespa_sync_task(self: Task, *, tenant_id: str) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        DocubrainRedisLocks.CHECK_VESPA_SYNC_BEAT_LOCK,
        ...
        if global_version.is_ee_version():
            try:
                fetch_user_groups = fetch_versioned_implementation(
                    "docubrain.db.user_group", "fetch_user_groups"
                )
        ...
        for key in keys:
            ...
            if key_str == DOCUMENT_SYNC_FENCE_KEY:
                ...
                monitor_usergroup_taskset = (
                    fetch_versioned_implementation_with_fallback(
                        "docubrain.background.celery.tasks.vespa.tasks",
                        "monitor_usergroup_taskset",
                        noop_fallback,
                    )
                )
...
def try_generate_user_group_sync_tasks(
    ...
    fetch_user_group = cast(
        ...
        fetch_versioned_implementation("docubrain.db.user_group", "fetch_user_group"),
    )
...
@shared_task(
    name=DocubrainCeleryTask.VESPA_METADATA_SYNC_TASK,
    bind=True,
...
def vespa_metadata_sync_task(self: Task, document_id: str, *, tenant_id: str) -> bool:
    ...
    completion_status = DocubrainCeleryTaskCompletionStatus.UNDEFINED
    ...
    try:
        with get_session_with_current_tenant() as db_session:
            ...
            if not doc:
                ...
                completion_status = DocubrainCeleryTaskCompletionStatus.SKIPPED
            else:
                # document set sync
                ...
                completion_status = DocubrainCeleryTaskCompletionStatus.SUCCEEDED
    except SoftTimeLimitExceeded:
        task_logger.info(f"SoftTimeLimitExceeded exception. doc={document_id}")
        completion_status = DocubrainCeleryTaskCompletionStatus.SOFT_TIME_LIMIT
        ...
        while True:
            ...
            if isinstance(e, httpx.HTTPStatusError):
                ...
                completion_status = (
                    DocubrainCeleryTaskCompletionStatus.NON_RETRYABLE_EXCEPTION
                )
                break
            ...
            completion_status = DocubrainCeleryTaskCompletionStatus.RETRYABLE_EXCEPTION
            if (
    ...
    return completion_status == DocubrainCeleryTaskCompletionStatus.SUCCEEDED
