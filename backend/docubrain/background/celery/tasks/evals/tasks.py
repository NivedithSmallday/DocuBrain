...
@shared_task(
    name=DocubrainCeleryTask.EVAL_RUN_TASK,
    ignore_result=True,
...
@shared_task(
    name=DocubrainCeleryTask.SCHEDULED_EVAL_TASK,
    ignore_result=True,
...
def scheduled_eval_task(self: Task, **kwargs: Any) -> None:  # noqa: ARG001
    ...
    - SCHEDULED_EVAL_PERMISSIONS_EMAIL: Email for search permissions (default: roshan@docubrain.app)
