...
from docubrain.db.connector_credential_pair import add_deletion_failure_message
...
from docubrain.db.document import (
    delete_all_documents_by_connector_credential_pair__no_commit,
)
from docubrain.db.document import get_document_ids_for_connector_credential_pair
from docubrain.db.document_set import delete_document_set_cc_pair_relationship__no_commit
...
from docubrain.db.index_attempt import delete_index_attempts
from docubrain.db.index_attempt import get_recent_attempts_for_cc_pair
...
from docubrain.db.search_settings import get_all_search_settings
...
from docubrain.redis.redis_connector_delete import RedisConnectorDeletePayload
...
@shared_task(
    name=DocubrainCeleryTask.CHECK_FOR_CONNECTOR_DELETION,
    ignore_result=True,
...
def check_for_connector_deletion_task(self: Task, *, tenant_id: str) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        DocubrainRedisLocks.CHECK_CONNECTOR_DELETION_BEAT_LOCK,
    ...
    try:
        ...
        lock_beat.reacquire()
        if not r.exists(DocubrainRedisSignals.BLOCK_VALIDATE_CONNECTOR_DELETION_FENCES):
            ...
            r.set(DocubrainRedisSignals.BLOCK_VALIDATE_CONNECTOR_DELETION_FENCES, 1, ex=300)
