...
from docubrain.configs.app_configs import AWS_REGION_NAME
from docubrain.configs.app_configs import S3_AWS_ACCESS_KEY_ID
from docubrain.configs.app_configs import S3_AWS_SECRET_ACCESS_KEY
from docubrain.configs.app_configs import S3_ENDPOINT_URL
from docubrain.configs.app_configs import S3_FILE_STORE_BUCKET_NAME
from docubrain.configs.app_configs import S3_FILE_STORE_PREFIX
from docubrain.configs.app_configs import S3_GENERATE_LOCAL_CHECKSUM
from docubrain.configs.app_configs import S3_VERIFY_SSL
...
from docubrain.db.engine.sql_engine import get_session_with_current_tenant_if_none
from docubrain.db.file_record import delete_filerecord_by_file_id
from docubrain.db.file_record import get_filerecord_by_file_id
from docubrain.db.file_record import get_filerecord_by_file_id_optional
from docubrain.db.file_record import get_filerecord_by_prefix
from docubrain.db.file_record import upsert_filerecord
from docubrain.db.models import FileRecord
from docubrain.db.models import FileRecord as FileStoreModel
from docubrain.file_store.s3_key_utils import generate_s3_key
...
class S3BackedFileStore(FileStore):
    ...
    def __init__(
        ...
        self._s3_prefix = s3_prefix or "docubrain-files"
...
def get_default_file_store() -> FileStore:
    ...
    """
    from docubrain.configs.app_configs import FILE_STORE_BACKEND
    from docubrain.configs.constants import FileStoreType

    if FileStoreType(FILE_STORE_BACKEND) == FileStoreType.POSTGRES:
        from docubrain.file_store.postgres_file_store import PostgresBackedFileStore
