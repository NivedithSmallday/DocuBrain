...
from docubrain.configs.constants import DOCUBRAIN_UTM_SOURCE
from docubrain.db.enums import AccountType
from docubrain.db.models import User
from docubrain.db.notification import batch_create_notifications
from docubrain.server.features.release_notes.constants import DOCS_CHANGELOG_BASE_URL
...
def create_release_notifications_for_versions(
    ...
    for entry in release_note_entries:
        ...
        utm_params = {
            "utm_source": DOCUBRAIN_UTM_SOURCE,
