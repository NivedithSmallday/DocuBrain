...
from docubrain.configs.app_configs import ENABLE_OPENSEARCH_RETRIEVAL_FOR_DOCUBRAIN
from docubrain.db.enums import OpenSearchDocumentMigrationStatus
...
def get_opensearch_retrieval_state(
    ...
    record = db_session.query(OpenSearchTenantMigrationRecord).first()
    if record is None:
        return ENABLE_OPENSEARCH_RETRIEVAL_FOR_DOCUBRAIN
