...
from docubrain.configs.constants import DEFAULT_BOOST
from docubrain.configs.constants import DocumentSource
from docubrain.configs.kg_configs import KG_SIMPLE_ANSWER_MAX_DISPLAYED_SOURCES
from docubrain.db.chunk import delete_chunk_stats_by_connector_credential_pair__no_commit
from docubrain.db.connector_credential_pair import get_connector_credential_pair_from_id
from docubrain.db.document_access import apply_document_access_filter
from docubrain.db.entities import delete_from_kg_entities__no_commit
from docubrain.db.entities import delete_from_kg_entities_extraction_staging__no_commit
from docubrain.db.enums import AccessType
from docubrain.db.enums import ConnectorCredentialPairStatus
from docubrain.db.feedback import delete_document_feedback_for_documents__no_commit
...
from docubrain.db.relationships import (
    delete_from_kg_relationships_extraction_staging__no_commit,
)
from docubrain.db.tag import delete_document_tags_for_documents__no_commit
from docubrain.db.utils import DocumentRow
from docubrain.db.utils import model_to_dict
from docubrain.db.utils import SortOrder
...
def get_access_info_for_documents(
    ...
    - List of emails of DocuBrain users with direct access to the doc (includes a "None" element if
