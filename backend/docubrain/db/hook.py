...
from docubrain.db.models import Hook
from docubrain.db.models import HookExecutionLog
...
def create_hook__no_commit(
    *,
    ...
    DocubrainError(CONFLICT) if a hook already exists, including under concurrent
...
def update_hook__no_commit(
    *,
    ...
    if hook is None:
        raise DocubrainError(DocubrainErrorCode.NOT_FOUND, f"Hook with id {hook_id} not found.")
