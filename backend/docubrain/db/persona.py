...
from docubrain.access.hierarchy_access import get_user_external_group_ids
from docubrain.auth.schemas import UserRole
from docubrain.configs.app_configs import CURATORS_CANNOT_VIEW_OR_EDIT_NON_OWNED_ASSISTANTS
from docubrain.configs.constants import DEFAULT_PERSONA_ID
from docubrain.configs.constants import NotificationType
from docubrain.db.constants import SLACK_BOT_PERSONA_PREFIX
from docubrain.db.document_access import get_accessible_documents_by_ids
...
from docubrain.db.models import FederatedConnector__DocumentSet
from docubrain.db.models import HierarchyNode
from docubrain.db.models import Persona
from docubrain.db.models import Persona__User
from docubrain.db.models import Persona__UserGroup
from docubrain.db.models import PersonaLabel
from docubrain.db.models import StarterMessage
from docubrain.db.models import Tool
from docubrain.db.models import User
from docubrain.db.models import User__UserGroup
from docubrain.db.models import UserFile
from docubrain.db.models import UserGroup
from docubrain.db.notification import create_notification
...
from docubrain.server.features.persona.models import PersonaSharedNotificationData
...
from docubrain.server.features.tool.tool_visibility import should_expose_tool_to_fe
...
def update_persona_access(
    ...
    if group_ids is not None:
        ...
        if group_ids:
            raise NotImplementedError("DocuBrain MIT does not support group-based sharing")
...
def create_update_persona(
    ...
    try:
        ...
        versioned_update_persona_access = fetch_versioned_implementation(
            "docubrain.db.persona", "update_persona_access"
        )
...
def validate_persona_tools(tools: list[Tool], db_session: Session) -> None:
    ...
    from docubrain.tools.built_in_tools import get_built_in_tool_by_id_optional

    for tool in tools:
        if tool.in_code_tool_id is not None:
            tool_cls = get_built_in_tool_by_id_optional(tool.in_code_tool_id)
            if tool_cls is None:
                continue
