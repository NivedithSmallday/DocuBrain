...
# document as represented in DocuBrain. What is actually stored in the index is the
...
class IndexRetrievalFilters(BaseModel):
    ...
    Used to filter on permissions and other DocuBrain-specific metadata rather than
...
class DocumentIndex(
    ...
    """
    A valid document index that can plug into all DocuBrain flows must implement all
