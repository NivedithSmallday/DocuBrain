...
from docubrain.configs.app_configs import DEFAULT_OPENSEARCH_QUERY_TIMEOUT_S
from docubrain.configs.app_configs import OPENSEARCH_EXPLAIN_ENABLED
from docubrain.configs.app_configs import OPENSEARCH_MATCH_HIGHLIGHTS_DISABLED
from docubrain.configs.app_configs import OPENSEARCH_PROFILING_DISABLED
from docubrain.configs.constants import DocumentSource
from docubrain.configs.constants import INDEX_SEPARATOR
...
from docubrain.document_index.opensearch.constants import ASSUMED_DOCUMENT_AGE_DAYS
from docubrain.document_index.opensearch.constants import (
...
from docubrain.document_index.opensearch.constants import HybridSearchNormalizationPipeline
from docubrain.document_index.opensearch.constants import HybridSearchSubqueryConfiguration
from docubrain.document_index.opensearch.schema import ACCESS_CONTROL_LIST_FIELD_NAME
from docubrain.document_index.opensearch.schema import ANCESTOR_HIERARCHY_NODE_IDS_FIELD_NAME
from docubrain.document_index.opensearch.schema import CHUNK_INDEX_FIELD_NAME
from docubrain.document_index.opensearch.schema import CONTENT_FIELD_NAME
from docubrain.document_index.opensearch.schema import CONTENT_VECTOR_FIELD_NAME
from docubrain.document_index.opensearch.schema import DOCUMENT_ID_FIELD_NAME
...
from docubrain.document_index.opensearch.schema import LAST_UPDATED_FIELD_NAME
from docubrain.document_index.opensearch.schema import MAX_CHUNK_SIZE_FIELD_NAME
from docubrain.document_index.opensearch.schema import METADATA_LIST_FIELD_NAME
from docubrain.document_index.opensearch.schema import PERSONAS_FIELD_NAME
from docubrain.document_index.opensearch.schema import PUBLIC_FIELD_NAME
from docubrain.document_index.opensearch.schema import set_or_convert_timezone_to_utc
from docubrain.document_index.opensearch.schema import SOURCE_TYPE_FIELD_NAME
from docubrain.document_index.opensearch.schema import TENANT_ID_FIELD_NAME
from docubrain.document_index.opensearch.schema import TITLE_FIELD_NAME
from docubrain.document_index.opensearch.schema import TITLE_VECTOR_FIELD_NAME
...
class DocumentQuery:
    ...
    def get_from_document_id_query(
        ...
        Args:
            document_id: DocuBrain document ID. Notably not an OpenSearch document
                ID, which points to what DocuBrain would refer to as a chunk.
