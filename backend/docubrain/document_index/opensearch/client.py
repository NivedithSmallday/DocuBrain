...
from docubrain.configs.app_configs import DEFAULT_OPENSEARCH_CLIENT_TIMEOUT_S
from docubrain.configs.app_configs import OPENSEARCH_ADMIN_PASSWORD
from docubrain.configs.app_configs import OPENSEARCH_ADMIN_USERNAME
from docubrain.configs.app_configs import OPENSEARCH_HOST
from docubrain.configs.app_configs import OPENSEARCH_REST_API_PORT
...
from docubrain.document_index.opensearch.search import DEFAULT_OPENSEARCH_MAX_RESULT_WINDOW
from docubrain.server.metrics.opensearch_search import observe_opensearch_search
from docubrain.server.metrics.opensearch_search import track_opensearch_search_in_progress
...
class OpenSearchIndexClient(OpenSearchClient):
    ...
    most methods here return the minimum data needed for the rest of DocuBrain, and
    ...
    def index_document(
        ...
        Args:
            document: The document to index. In DocuBrain this is a chunk of a
    ...
    def bulk_index_documents(
        ...
        Args:
            documents: The documents to index. In DocuBrain this is a chunk of a
                document, OpenSearch simply refers to this as a document as
                well.
            tenant_state: The tenant state of the caller.
            update_if_exists: Whether to update the document if it already
