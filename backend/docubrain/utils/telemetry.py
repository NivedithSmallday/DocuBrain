...
from docubrain.configs.app_configs import ENTERPRISE_EDITION_ENABLED
from docubrain.configs.constants import KV_CUSTOMER_UUID_KEY
from docubrain.configs.constants import KV_INSTANCE_DOMAIN_KEY
...
_DANSWER_TELEMETRY_ENDPOINT = "https://telemetry.docubrain.app/anonymous_telemetry"
...
def optional_telemetry(
    ...
    try:
        ...
        # Should never interfere with normal functions of DocuBrain
        pass
...
def mt_cloud_telemetry(
    ...
    # This is only for DocuBrain MT Cloud, this code should also never be hit, no reason for any orgs to
    # be running the Multi Tenant version of DocuBrain.
    fetch_versioned_implementation_with_fallback(
        module="docubrain.utils.telemetry",
