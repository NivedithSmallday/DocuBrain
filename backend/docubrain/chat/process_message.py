...
from docubrain.chat.chat_processing_checker import set_processing_status
from docubrain.chat.chat_state import AvailableFiles
from docubrain.chat.chat_state import ChatStateContainer
from docubrain.chat.chat_state import ChatTurnSetup
from docubrain.chat.chat_utils import build_file_context
from docubrain.chat.chat_utils import convert_chat_history
from docubrain.chat.chat_utils import create_chat_history_chain
from docubrain.chat.chat_utils import create_chat_session_from_request
from docubrain.chat.chat_utils import get_custom_agent_prompt
from docubrain.chat.chat_utils import is_last_assistant_message_clarification
from docubrain.chat.chat_utils import load_all_chat_files
from docubrain.chat.compression import calculate_total_history_tokens
from docubrain.chat.compression import compress_chat_history
from docubrain.chat.compression import find_summary_for_branch
from docubrain.chat.compression import get_compression_params
from docubrain.chat.emitter import Emitter
from docubrain.chat.llm_loop import EmptyLLMResponseError
from docubrain.chat.llm_loop import run_llm_loop
from docubrain.chat.models import AnswerStream
from docubrain.chat.models import AnswerStreamPart
from docubrain.chat.models import ChatBasicResponse
from docubrain.chat.models import ChatFullResponse
from docubrain.chat.models import ChatLoadedFile
from docubrain.chat.models import ChatMessageSimple
from docubrain.chat.models import ContextFileMetadata
from docubrain.chat.models import CreateChatSessionID
from docubrain.chat.models import ExtractedContextFiles
from docubrain.chat.models import FileToolMetadata
from docubrain.chat.models import SearchParams
from docubrain.chat.models import StreamingError
from docubrain.chat.models import ToolCallResponse
from docubrain.chat.prompt_utils import calculate_reserved_tokens
from docubrain.chat.save_chat import save_chat_turn
from docubrain.chat.stop_signal_checker import is_connected as check_stop_signal
from docubrain.chat.stop_signal_checker import reset_cancel_status
...
from docubrain.db.chat import create_new_chat_message
from docubrain.db.chat import get_chat_session_by_id
from docubrain.db.chat import get_or_create_root_message
from docubrain.db.chat import reserve_message_id
from docubrain.db.chat import reserve_multi_model_message_ids
from docubrain.db.engine.sql_engine import get_session_with_current_tenant
from docubrain.db.enums import HookPoint
from docubrain.db.memory import get_memories
from docubrain.db.models import ChatMessage
from docubrain.db.models import Persona
from docubrain.db.models import User
from docubrain.db.models import UserFile
from docubrain.db.projects import get_user_files_from_project
from docubrain.db.tools import get_tools
from docubrain.deep_research.dr_loop import run_deep_research_llm_loop
...
from docubrain.file_processing.extract_file_text import extract_file_text
from docubrain.file_store.models import ChatFileType
from docubrain.file_store.models import InMemoryChatFile
from docubrain.file_store.utils import load_in_memory_chat_files
from docubrain.file_store.utils import verify_user_files
from docubrain.hooks.executor import execute_hook
from docubrain.hooks.executor import HookSkipped
from docubrain.hooks.executor import HookSoftFailed
from docubrain.hooks.points.query_processing import QueryProcessingPayload
from docubrain.hooks.points.query_processing import QueryProcessingResponse
from docubrain.llm.factory import get_llm_for_persona
from docubrain.llm.factory import get_llm_token_counter
from docubrain.llm.interfaces import LLM
from docubrain.llm.interfaces import LLMUserIdentity
from docubrain.llm.override_models import LLMOverride
from docubrain.llm.request_context import reset_llm_mock_response
from docubrain.llm.request_context import set_llm_mock_response
from docubrain.llm.utils import litellm_exception_to_error_msg
from docubrain.docubrainbot.slack.models import SlackContext
from docubrain.server.query_and_chat.chat_utils import mime_type_to_chat_file_type
from docubrain.server.query_and_chat.models import AUTO_PLACE_AFTER_LATEST_MESSAGE
from docubrain.server.query_and_chat.models import MessageResponseIDInfo
from docubrain.server.query_and_chat.models import ModelResponseSlot
from docubrain.server.query_and_chat.models import MultiModelMessageResponseIDInfo
...
from docubrain.server.usage_limits import check_llm_cost_limit_for_provider
from docubrain.tools.constants import FILE_READER_TOOL_ID
from docubrain.tools.constants import SEARCH_TOOL_ID
from docubrain.tools.models import ChatFile
from docubrain.tools.models import SearchToolUsage
from docubrain.tools.tool_constructor import construct_tools
from docubrain.tools.tool_constructor import CustomToolConfig
from docubrain.tools.tool_constructor import FileReaderToolConfig
from docubrain.tools.tool_constructor import SearchToolConfig
...
def _resolve_query_processing_hook_result(
    ...
    Returns the (possibly rewritten) message text, or raises DocubrainError with
    ...
    if not (hook_result.query and hook_result.query.strip()):
        raise DocubrainError(
            DocubrainErrorCode.QUERY_REJECTED,
...
def build_chat_turn(
    ...
    *,
    ...
    # Check LLM cost limits before using the LLM (only for DocuBrain-managed keys),
...
def _stream_chat_turn(
    ...
    try:
        ...
        if e.error_code is not DocubrainErrorCode.QUERY_REJECTED:
            log_docubrain_error(e)
        yield StreamingError(
            error=e.detail,
