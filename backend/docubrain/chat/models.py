...
from docubrain.tools.tool_implementations.custom.base_tool_types import ToolResultType
...
class ChatFullResponse(BaseModel):
    ...
    NOTE: This model is used for the core flow of the DocuBrain application, any changes to it should be reviewed and approved by an
