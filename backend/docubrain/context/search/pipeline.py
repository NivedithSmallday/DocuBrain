...
from docubrain.context.search.retrieval.search_runner import search_chunks
...
from docubrain.natural_language_processing.english_stopwords import strip_stopwords
from docubrain.natural_language_processing.search_nlp_models import EmbeddingModel
from docubrain.secondary_llm_flows.source_filter import extract_source_filter
from docubrain.secondary_llm_flows.time_filter import extract_time_filter
from docubrain.utils.logger import setup_logger
from docubrain.utils.threadpool_concurrency import FunctionCall
from docubrain.utils.threadpool_concurrency import run_functions_in_parallel
...
def search_pipeline(
    ...
    censored_chunks: list[InferenceChunk] = fetch_ee_implementation_or_noop(
        "docubrain.external_permissions.post_query_censoring",
