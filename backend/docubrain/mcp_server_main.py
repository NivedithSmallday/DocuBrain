...
from docubrain.configs.app_configs import MCP_SERVER_HOST
from docubrain.configs.app_configs import MCP_SERVER_PORT
...
def main() -> None:
    ...
    from docubrain.mcp_server.api import mcp_app
