...
from docubrain.configs.app_configs import GOOGLE_DRIVE_CONNECTOR_SIZE_THRESHOLD
from docubrain.configs.app_configs import INDEX_BATCH_SIZE
from docubrain.configs.app_configs import MAX_DRIVE_WORKERS
...
from docubrain.connectors.exceptions import CredentialExpiredError
from docubrain.connectors.exceptions import InsufficientPermissionsError
from docubrain.connectors.google_drive.doc_conversion import build_slim_document
from docubrain.connectors.google_drive.doc_conversion import (
...
from docubrain.connectors.google_drive.file_retrieval import (
    get_all_files_in_my_drive_and_shared,
)
from docubrain.connectors.google_drive.file_retrieval import get_external_access_for_folder
from docubrain.connectors.google_drive.file_retrieval import get_files_in_shared_drive
from docubrain.connectors.google_drive.file_retrieval import get_folder_metadata
from docubrain.connectors.google_drive.file_retrieval import get_root_folder_id
from docubrain.connectors.google_drive.file_retrieval import get_shared_drive_name
from docubrain.connectors.google_drive.file_retrieval import has_link_only_permission
from docubrain.connectors.google_drive.models import DriveRetrievalStage
from docubrain.connectors.google_drive.models import GoogleDriveCheckpoint
from docubrain.connectors.google_drive.models import GoogleDriveFileType
from docubrain.connectors.google_drive.models import RetrievedDriveFile
from docubrain.connectors.google_drive.models import StageCompletion
from docubrain.connectors.google_utils.google_auth import get_google_creds
from docubrain.connectors.google_utils.google_utils import execute_paginated_retrieval
from docubrain.connectors.google_utils.google_utils import get_file_owners
from docubrain.connectors.google_utils.google_utils import GoogleFields
from docubrain.connectors.google_utils.resources import get_admin_service
from docubrain.connectors.google_utils.resources import get_drive_service
from docubrain.connectors.google_utils.resources import GoogleDriveService
from docubrain.connectors.google_utils.shared_constants import (
    DB_CREDENTIALS_PRIMARY_ADMIN_KEY,
)
from docubrain.connectors.google_utils.shared_constants import MISSING_SCOPES_ERROR_STR
from docubrain.connectors.google_utils.shared_constants import DOCUBRAIN_SCOPE_INSTRUCTIONS
from docubrain.connectors.google_utils.shared_constants import SLIM_BATCH_SIZE
from docubrain.connectors.google_utils.shared_constants import USER_FIELDS
from docubrain.connectors.interfaces import CheckpointedConnectorWithPermSync
from docubrain.connectors.interfaces import CheckpointOutput
from docubrain.connectors.interfaces import GenerateSlimDocumentOutput
from docubrain.connectors.interfaces import NormalizationResult
from docubrain.connectors.interfaces import SecondsSinceUnixEpoch
from docubrain.connectors.interfaces import SlimConnectorWithPermSync
from docubrain.connectors.models import ConnectorFailure
from docubrain.connectors.models import ConnectorMissingCredentialError
from docubrain.connectors.models import Document
from docubrain.connectors.models import EntityFailure
...
from docubrain.utils.threadpool_concurrency import parallel_yield
from docubrain.utils.threadpool_concurrency import run_functions_tuples_in_parallel
from docubrain.utils.threadpool_concurrency import ThreadSafeDict
from docubrain.utils.threadpool_concurrency import ThreadSafeSet
...
class GoogleDriveConnector(
    ...
    def normalize_url(cls, url: str) -> NormalizationResult:
        ...
        docubrain_document_id_from_drive_file.
        """
        parsed = urlparse(url)
        ...
        normalized = docubrain_document_id_from_drive_file(file_obj).rstrip("/")
        return NormalizationResult(normalized_url=normalized, use_default=False)
    ...
    def _checkpointed_retrieval(
        ...
        for file in drive_files:
            ...
            try:
                document_id = docubrain_document_id_from_drive_file(drive_file)
    ...
    def _load_from_checkpoint(
        ...
        try:
            ...
            if MISSING_SCOPES_ERROR_STR in str(e):
                raise PermissionError(DOCUBRAIN_SCOPE_INSTRUCTIONS) from e
            raise e
        checkpoint.retrieved_folder_and_drive_ids = self._retrieved_folder_and_drive_ids
    ...
    def validate_connector_settings(self) -> None:
        ...
        try:
            ...
            if MISSING_SCOPES_ERROR_STR in str(e):
                raise InsufficientPermissionsError(
                    f"Google Drive credentials are missing required scopes. {DOCUBRAIN_SCOPE_INSTRUCTIONS}"
                )
            raise ConnectorValidationError(
