...
from docubrain.configs.app_configs import CONNECTOR_LOCALHOST_OVERRIDE
from docubrain.configs.constants import DocumentSource
from docubrain.configs.constants import IGNORE_FOR_QA
from docubrain.connectors.models import BasicExpertInfo
from docubrain.connectors.models import DocubrainMetadata
from docubrain.utils.logger import setup_logger
from docubrain.utils.text_processing import is_valid_email
...
def process_docubrain_metadata(
    metadata: dict[str, Any],
) -> tuple[DocubrainMetadata, dict[str, Any]]:
    """
    Users may set DocuBrain metadata and custom tags in text files. https://docs.docubrain.app/admins/connectors/official/file
