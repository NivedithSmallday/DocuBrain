...
from docubrain.utils.text_processing import make_url_compatible
...
class DocumentBase(BaseModel):
    """Used for DocuBrain ingestion api, the ID is inferred before use if not provided"""
...
class Document(DocumentBase):
    """Used for DocuBrain ingestion api, the ID is required"""
...
class DocubrainMetadata(BaseModel):
