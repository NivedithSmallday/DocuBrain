...
SCOPE_DOC_URL = "https://docs.docubrain.app/admins/connectors/official/google_drive/overview"
DOCUBRAIN_SCOPE_INSTRUCTIONS = (
    "You have upgraded DocuBrain without updating the Google Auth scopes. "
