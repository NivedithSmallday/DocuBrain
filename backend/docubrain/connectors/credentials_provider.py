...
from docubrain.connectors.interfaces import CredentialsProviderInterface
...
class DocubrainDBCredentialsProvider(
    CredentialsProviderInterface["DocubrainDBCredentialsProvider"]
):
    ...
    def __enter__(self) -> "DocubrainDBCredentialsProvider":
...
class DocubrainStaticCredentialsProvider(
    CredentialsProviderInterface["DocubrainStaticCredentialsProvider"]
):
    ...
    def __enter__(self) -> "DocubrainStaticCredentialsProvider":
        return self
