...
from docubrain.connectors.credentials_provider import DocubrainDBCredentialsProvider
...
from docubrain.connectors.interfaces import CredentialsConnector
from docubrain.connectors.interfaces import EventConnector
...
from docubrain.connectors.registry import CONNECTOR_CLASS_MAP
from docubrain.db.connector import fetch_connector_by_id
from docubrain.db.credentials import backend_update_credential_json
from docubrain.db.credentials import fetch_credential_by_id
...
def instantiate_connector(
    ...
    if isinstance(connector, CredentialsConnector):
        provider = DocubrainDBCredentialsProvider(
