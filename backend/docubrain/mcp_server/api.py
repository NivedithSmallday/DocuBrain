...
from docubrain.configs.app_configs import MCP_SERVER_CORS_ORIGINS
from docubrain.mcp_server.auth import DocubrainTokenVerifier
from docubrain.mcp_server.utils import shutdown_http_client
from docubrain.utils.logger import setup_logger

logger = setup_logger()

logger.info("Creating DocuBrain MCP Server...")

mcp_server = FastMCP(
    name="DocuBrain MCP Server",
    version="1.0.0",
