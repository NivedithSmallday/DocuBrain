...
from docubrain.configs.app_configs import DISABLE_INDEX_UPDATE_ON_SWAP
...
from docubrain.configs.app_configs import VESPA_NUM_ATTEMPTS_ON_STARTUP
from docubrain.configs.constants import KV_REINDEX_KEY
from docubrain.configs.embedding_configs import SUPPORTED_EMBEDDING_MODELS
from docubrain.configs.embedding_configs import SupportedEmbeddingModel
from docubrain.configs.model_configs import GEN_AI_API_KEY
from docubrain.configs.model_configs import GEN_AI_MODEL_VERSION
from docubrain.context.search.models import SavedSearchSettings
from docubrain.db.connector import check_connectors_exist
from docubrain.db.connector import create_initial_default_connector
from docubrain.db.connector_credential_pair import associate_default_cc_pair
from docubrain.db.connector_credential_pair import get_connector_credential_pairs
from docubrain.db.connector_credential_pair import resync_cc_pair
from docubrain.db.credentials import create_initial_public_credential
from docubrain.db.document import check_docs_exist
from docubrain.db.enums import EmbeddingPrecision
from docubrain.db.index_attempt import cancel_indexing_attempts_past_model
from docubrain.db.index_attempt import expire_index_attempts
...
from docubrain.db.search_settings import update_current_search_settings
...
from docubrain.document_index.opensearch.opensearch_document_index import set_cluster_state
from docubrain.document_index.vespa.index import VespaIndex
from docubrain.indexing.models import IndexingSetting
...
from docubrain.llm.well_known_providers.llm_provider_options import get_openai_model_names
...
from docubrain.server.settings.store import store_settings
from docubrain.utils.gpu_utils import gpu_status_request
...
def setup_docubrain(
    ...
    """
    Setup DocuBrain for a particular tenant. In the Single Tenant case, it will set it up for the default schema
...
def setup_multitenant_docubrain() -> None:
    if DISABLE_VECTOR_DB:
