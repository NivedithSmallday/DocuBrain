...
from docubrain.configs.app_configs import MOCK_LLM_RESPONSE
from docubrain.configs.chat_configs import LLM_SOCKET_READ_TIMEOUT
from docubrain.configs.model_configs import GEN_AI_TEMPERATURE
from docubrain.configs.model_configs import LITELLM_EXTRA_BODY
from docubrain.llm.constants import LlmProviderNames
from docubrain.llm.cost import calculate_llm_cost_cents
...
from docubrain.llm.interfaces import ReasoningEffort
from docubrain.llm.interfaces import ToolChoiceOptions
from docubrain.llm.model_response import ModelResponse
from docubrain.llm.model_response import ModelResponseStream
from docubrain.llm.model_response import Usage
from docubrain.llm.models import ANTHROPIC_REASONING_EFFORT_BUDGET
from docubrain.llm.models import OPENAI_REASONING_EFFORT
from docubrain.llm.request_context import get_llm_mock_response
from docubrain.llm.utils import build_litellm_passthrough_kwargs
from docubrain.llm.utils import is_true_openai_model
from docubrain.llm.utils import model_is_reasoning_model
from docubrain.llm.well_known_providers.constants import AWS_ACCESS_KEY_ID_KWARG
...
from docubrain.llm.well_known_providers.constants import AWS_REGION_NAME_KWARG
from docubrain.llm.well_known_providers.constants import AWS_REGION_NAME_KWARG_ENV_VAR_FORMAT
from docubrain.llm.well_known_providers.constants import AWS_SECRET_ACCESS_KEY_KWARG
from docubrain.llm.well_known_providers.constants import (
...
from docubrain.llm.well_known_providers.constants import VERTEX_LOCATION_KWARG
...
class LitellmLLM(LLM):
    ...
    def _track_llm_cost(self, usage: Usage) -> None:
        """
        Track LLM usage cost for DocuBrain-managed API keys.
        ...
        2. The API key is one of DocuBrain's managed default keys
        """
        ...
        from docubrain.server.usage_limits import is_docubrain_managed_api_key

        if not is_docubrain_managed_api_key(self._api_key):
            return
    ...
    def _completion(
        ...
        from docubrain.llm.litellm_singleton import litellm
    ...
    def invoke(
        ...
        from docubrain.llm.model_response import from_litellm_model_response
        ...
        try:
            ...
            # Track LLM cost for DocuBrain-managed API keys
    ...
    def stream(
        ...
        from docubrain.llm.model_response import from_litellm_model_response_stream
