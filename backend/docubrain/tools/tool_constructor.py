...
from docubrain.tools.tool_implementations.custom.custom_tool import (
...
from docubrain.tools.tool_implementations.open_url.open_url_tool import (
    OpenURLTool,
)
from docubrain.tools.tool_implementations.search.search_tool import SearchTool
from docubrain.utils.headers import header_dict_to_header_list
...
def construct_tools(
    ...
    for db_tool_model in persona.tools:
        ...
        if db_tool_model.in_code_tool_id:
            tool_cls = get_built_in_tool_by_id_optional(db_tool_model.in_code_tool_id)
            if tool_cls is None:
                logger.warning(
                    "Skipping stale built-in tool reference '%s' for persona '%s' (id=%s)",
            ...
            # Handle Open URL Tool
                ...
                try:
                    ...
                    raise ValueError(
                        "Open URL tool requires a web content provider, please contact your DocuBrain admin to get it configured!"
                    )
