...
from docubrain.chat.citation_utils import collapse_citations
...
from docubrain.chat.llm_step import run_llm_step_pkt_generator
...
from docubrain.deep_research.dr_mock_tools import (
    get_research_agent_additional_tool_definitions,
)
from docubrain.deep_research.dr_mock_tools import RESEARCH_AGENT_TASK_KEY
from docubrain.deep_research.dr_mock_tools import THINK_TOOL_RESPONSE_MESSAGE
from docubrain.deep_research.dr_mock_tools import THINK_TOOL_RESPONSE_TOKEN_COUNT
from docubrain.deep_research.models import CombinedResearchAgentCallResult
from docubrain.deep_research.models import ResearchAgentCallResult
from docubrain.deep_research.utils import check_special_tool_calls
from docubrain.deep_research.utils import create_think_tool_token_processor
...
from docubrain.llm.models import ToolChoiceOptions
from docubrain.prompts.deep_research.dr_tool_prompts import OPEN_URLS_TOOL_DESCRIPTION
from docubrain.prompts.deep_research.dr_tool_prompts import (
    OPEN_URLS_TOOL_DESCRIPTION_REASONING,
)
from docubrain.prompts.deep_research.dr_tool_prompts import WEB_SEARCH_TOOL_DESCRIPTION
from docubrain.prompts.deep_research.research_agent import MAX_RESEARCH_CYCLES
from docubrain.prompts.deep_research.research_agent import OPEN_URL_REMINDER_RESEARCH_AGENT
from docubrain.prompts.deep_research.research_agent import RESEARCH_AGENT_PROMPT
from docubrain.prompts.deep_research.research_agent import RESEARCH_AGENT_PROMPT_REASONING
from docubrain.prompts.deep_research.research_agent import RESEARCH_REPORT_PROMPT
from docubrain.prompts.deep_research.research_agent import USER_REPORT_QUERY
from docubrain.prompts.prompt_utils import get_current_llm_day_time
...
from docubrain.server.query_and_chat.streaming_models import IntermediateReportCitedDocs
...
from docubrain.server.query_and_chat.streaming_models import PacketException
...
from docubrain.server.query_and_chat.streaming_models import StreamingType
...
from docubrain.tools.utils import generate_tools_description
from docubrain.tracing.framework.create import function_span
...
def extract_url_snippet_map(search_docs: list[Any]) -> dict[str, str]:
    return {
        search_doc.link: search_doc.blurb
        for search_doc in search_docs
        if getattr(search_doc, "link", None) and getattr(search_doc, "blurb", None)
    }
        ...
        try:
            ...
            while research_cycle_count <= MAX_RESEARCH_CYCLES:
                ...
                web_search_tip = (
                    ...
                    if any(tool.name == INTERNET_SEARCH_TOOL_NAME for tool in current_tools)
                    else ""
                )
                open_urls_tip = (
                ...
                if special_tool_calls.generate_report_tool_call:
                    ...
                    for tool_response in valid_tool_responses:
                        ...
                        if isinstance(tool_response.rich_response, SearchDocsResponse):
                            ...
                            if search_docs and tc.tool_name == INTERNET_SEARCH_TOOL_NAME:
...
if __name__ == "__main__":
    ...
    from docubrain.llm.utils import model_is_reasoning_model
    from docubrain.server.query_and_chat.placement import Placement
    from docubrain.tools.models import ToolCallKickoff
