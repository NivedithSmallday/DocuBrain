...
from docubrain.hooks.points.base import HookPointSpec
...
class DocumentIngestionPayload(BaseModel):
    ...
    source: str = Field(
        description=(
            ...
            "Full list of values: https://github.com/docubrain-dot-app/docubrain/blob/main/backend/docubrain/configs/constants.py#L195"
        )
    )
...
class DocumentIngestionSpec(HookPointSpec):
    ...
    Call site: immediately after DocuBrain's internal validation and before the
    ...
    docs_url = "https://docs.docubrain.app/admins/advanced_configs/hook_extensions#document-ingestion"
