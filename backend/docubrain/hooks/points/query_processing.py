...
class QueryProcessingSpec(HookPointSpec):
    ...
    backend/docubrain/chat/process_message.py, immediately after message_text is
    ...
    docs_url = (
        "https://docs.docubrain.app/admins/advanced_configs/hook_extensions#query-processing"
    )
