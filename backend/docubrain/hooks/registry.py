...
from docubrain.hooks.points.document_ingestion import DocumentIngestionSpec
from docubrain.hooks.points.query_processing import QueryProcessingSpec
...
def validate_registry() -> None:
    ...
    if missing:
        raise RuntimeError(
            ...
            "Add an entry to docubrain.hooks.registry._REGISTRY."
        )
