...
from docubrain.db.models import Notification as NotificationDBModel
...
class UserSettings(Settings):
    ...
    # Feature flag for DocuBrain Craft (Build Mode) - used for server-side redirects
    docubrain_craft_enabled: bool = False
    ...
    # Application version, read from the DOCUBRAIN_VERSION env var at startup.
