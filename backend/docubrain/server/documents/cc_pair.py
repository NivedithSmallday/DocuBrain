...
from docubrain.background.indexing.models import IndexAttemptErrorPydantic
...
from docubrain.connectors.exceptions import ValidationError
...
from docubrain.db.connector_credential_pair import remove_credential_from_connector
from docubrain.db.connector_credential_pair import (
    update_connector_credential_pair_from_id,
)
from docubrain.db.connector_credential_pair import verify_user_has_access_to_cc_pair
from docubrain.db.document import get_document_counts_for_cc_pairs
from docubrain.db.document import get_documents_for_cc_pair
...
from docubrain.db.enums import PermissionSyncStatus
from docubrain.db.index_attempt import count_index_attempt_errors_for_cc_pair
from docubrain.db.index_attempt import count_index_attempts_for_cc_pair
from docubrain.db.index_attempt import get_index_attempt_errors_for_cc_pair
from docubrain.db.index_attempt import get_latest_index_attempt_for_cc_pair_id
from docubrain.db.index_attempt import (
    get_latest_successful_index_attempt_for_cc_pair_id,
)
from docubrain.db.index_attempt import get_paginated_index_attempts_for_cc_pair_id
...
from docubrain.db.permission_sync_attempt import (
...
from docubrain.redis.redis_connector_utils import get_deletion_attempt_snapshot
from docubrain.redis.redis_pool import get_redis_client
from docubrain.server.documents.models import CCPairFullInfo
from docubrain.server.documents.models import CCPropertyUpdateRequest
from docubrain.server.documents.models import CCStatusUpdateRequest
from docubrain.server.documents.models import ConnectorCredentialPairIdentifier
from docubrain.server.documents.models import ConnectorCredentialPairMetadata
from docubrain.server.documents.models import DocumentSyncStatus
from docubrain.server.documents.models import IndexAttemptSnapshot
from docubrain.server.documents.models import PaginatedReturn
from docubrain.server.documents.models import PermissionSyncAttemptSnapshot
