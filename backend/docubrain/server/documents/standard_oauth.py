...
from docubrain.connectors.interfaces import OAuthConnector
...
from docubrain.utils.subclasses import find_all_subclasses_in_package
...
def _discover_oauth_connectors() -> dict[DocumentSource, type[OAuthConnector]]:
    ...
    oauth_connectors = find_all_subclasses_in_package(
        cast(type[OAuthConnector], OAuthConnector), "docubrain.connectors"
    )
