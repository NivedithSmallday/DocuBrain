...
# Example: /var/docubrain/file-system or /app/file-system
...
SANDBOX_BASE_PATH = os.environ.get("SANDBOX_BASE_PATH", "/tmp/docubrain-sandboxes")
...
SANDBOX_NAMESPACE = os.environ.get("SANDBOX_NAMESPACE", "docubrain-sandboxes")
...
SANDBOX_CONTAINER_IMAGE = os.environ.get(
    "SANDBOX_CONTAINER_IMAGE", "docubraindotapp/sandbox:v0.1.5"
)
...
SANDBOX_S3_BUCKET = os.environ.get("SANDBOX_S3_BUCKET", "docubrain-sandbox-files")
