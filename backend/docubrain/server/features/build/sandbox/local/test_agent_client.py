...
Usage:
  ...
  PYTHONPATH=. python docubrain/server/features/build/sandbox/local/test_agent_client.py

  # Or with specific message:
  PYTHONPATH=. python docubrain/server/features/build/sandbox/local/test_agent_client.py "What files are in this directory?"

  # With specific working directory:
  PYTHONPATH=. python docubrain/server/features/build/sandbox/local/test_agent_client.py --dir /path/to/project "List files"
"""
