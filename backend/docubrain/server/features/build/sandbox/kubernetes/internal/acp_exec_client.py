...
from docubrain.server.features.build.configs import ACP_MESSAGE_TIMEOUT
from docubrain.server.features.build.configs import SSE_KEEPALIVE_INTERVAL
...
# Default client info
DEFAULT_CLIENT_INFO = {
    "name": "docubrain-sandbox-k8s-exec",
    "title": "DocuBrain Sandbox Agent Client (K8s Exec)",
    "version": "1.0.0",
}
