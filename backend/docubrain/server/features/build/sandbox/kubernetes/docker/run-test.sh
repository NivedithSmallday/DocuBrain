...
#
# This script:
# 1. Builds the docubrain-backend Docker image
...
IMAGE_NAME="docubraindotapp/docubrain-backend:latest"
TEST_FILE="docubrain/server/features/build/sandbox/kubernetes/test_kubernetes_sandbox.py"
...
echo "=== Building docubrain-backend Docker image ==="
...
kind load docker-image "$IMAGE_NAME" --name docubrain 2>/dev/null || \
