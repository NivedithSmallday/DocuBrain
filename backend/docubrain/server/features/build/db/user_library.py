...
from docubrain.server.features.build.configs import USER_LIBRARY_CONNECTOR_NAME
from docubrain.server.features.build.configs import USER_LIBRARY_CREDENTIAL_NAME
...
def get_or_create_craft_connector(db_session: Session, user: User) -> tuple[int, int]:
    ...
    authentication. This is because DocuBrain's connector-credential pair system
