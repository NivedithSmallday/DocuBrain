...
This module defines CUSTOM DocuBrain packet types that extend ACP (Agent Client Protocol).
ACP events are passed through directly from the agent - this module only contains
DocuBrain-specific extensions like artifacts and file operations.
...
Custom DocuBrain packets (defined here):
- error: DocuBrain-specific errors (e.g., session not found)
...
class BasePacket(BaseModel):
    """Base packet with common fields for all custom DocuBrain packet types."""
...
# =============================================================================
# Custom DocuBrain Packets
# =============================================================================


class ErrorPacket(BasePacket):
    """A DocuBrain-specific error occurred (e.g., session not found, sandbox not running)."""
...
# =============================================================================
# Union Type for Custom DocuBrain Packets
# =============================================================================
