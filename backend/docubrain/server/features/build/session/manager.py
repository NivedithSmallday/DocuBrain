...
from docubrain.db.enums import SandboxStatus
from docubrain.db.llm import fetch_default_llm_model
from docubrain.db.models import BuildMessage
from docubrain.db.models import BuildSession
from docubrain.db.models import User
from docubrain.db.users import fetch_user_by_id
from docubrain.llm.factory import get_default_llm
from docubrain.llm.models import LanguageModelInput
...
from docubrain.server.features.build.api.models import DirectoryListing
from docubrain.server.features.build.api.models import FileSystemEntry
from docubrain.server.features.build.api.packet_logger import get_packet_logger
from docubrain.server.features.build.api.packet_logger import log_separator
from docubrain.server.features.build.api.packets import BuildPacket
from docubrain.server.features.build.api.packets import ErrorPacket
from docubrain.server.features.build.api.rate_limit import get_user_rate_limit_status
from docubrain.server.features.build.configs import MAX_TOTAL_UPLOAD_SIZE_BYTES
from docubrain.server.features.build.configs import MAX_UPLOAD_FILES_PER_SESSION
from docubrain.server.features.build.configs import PERSISTENT_DOCUMENT_STORAGE_PATH
from docubrain.server.features.build.configs import SANDBOX_BACKEND
from docubrain.server.features.build.configs import SandboxBackend
from docubrain.server.features.build.db.build_session import allocate_nextjs_port
from docubrain.server.features.build.db.build_session import create_build_session__no_commit
from docubrain.server.features.build.db.build_session import create_message
from docubrain.server.features.build.db.build_session import delete_build_session__no_commit
from docubrain.server.features.build.db.build_session import (
    fetch_llm_provider_by_type_for_build_mode,
)
from docubrain.server.features.build.db.build_session import get_build_session
from docubrain.server.features.build.db.build_session import get_empty_session_for_user
from docubrain.server.features.build.db.build_session import get_session_messages
from docubrain.server.features.build.db.build_session import get_user_build_sessions
from docubrain.server.features.build.db.build_session import update_session_activity
from docubrain.server.features.build.db.build_session import upsert_agent_plan
from docubrain.server.features.build.db.sandbox import create_sandbox__no_commit
from docubrain.server.features.build.db.sandbox import get_running_sandbox_count_by_tenant
from docubrain.server.features.build.db.sandbox import get_sandbox_by_session_id
from docubrain.server.features.build.db.sandbox import get_sandbox_by_user_id
from docubrain.server.features.build.db.sandbox import get_snapshots_for_session
from docubrain.server.features.build.db.sandbox import update_sandbox_heartbeat
from docubrain.server.features.build.db.sandbox import update_sandbox_status__no_commit
from docubrain.server.features.build.sandbox import get_sandbox_manager
from docubrain.server.features.build.sandbox.kubernetes.internal.acp_exec_client import (
    SSEKeepalive,
)
from docubrain.server.features.build.sandbox.models import LLMProviderConfig
from docubrain.server.features.build.sandbox.tasks.tasks import (
    _get_disabled_user_library_paths,
)
from docubrain.server.features.build.session.prompts import BUILD_NAMING_SYSTEM_PROMPT
from docubrain.server.features.build.session.prompts import BUILD_NAMING_USER_PROMPT
from docubrain.server.features.build.session.prompts import (
    FOLLOWUP_SUGGESTIONS_SYSTEM_PROMPT,
)
from docubrain.server.features.build.session.prompts import FOLLOWUP_SUGGESTIONS_USER_PROMPT
...
class SessionManager:
    ...
    def create_session__no_commit(
        ...
        if MULTI_TENANT:
            from docubrain.server.features.build.configs import (
        ...
        if PERSISTENT_DOCUMENT_STORAGE_PATH:
            ...
            user_file_system_path = "/tmp/docubrain-files"
    ...
    def delete_session(
        ...
        if snapshots:
            ...
            from docubrain.server.features.build.sandbox.manager.snapshot_manager import (
                SnapshotManager,
            )
    ...
    def _check_nextjs_ready(self, sandbox_id: UUID, port: int) -> bool:
        ...
        from docubrain.server.features.build.sandbox.base import get_sandbox_manager
    ...
    def terminate_user_sandbox(self, user_id: UUID) -> bool:
        ...
        """
        from docubrain.server.features.build.db.sandbox import (
            update_sandbox_status__no_commit,
        )
