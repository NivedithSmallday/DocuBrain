...
from docubrain.file_processing.password_validation import is_file_password_protected
...
def _skip_token_threshold(extension: str) -> bool:
    ...
    return extension.lower() in DocubrainFileExtensions.TABULAR_EXTENSIONS
...
def categorize_uploaded_files(
    ...
    for upload in files:
        try:
            ...
            if extension in DocubrainFileExtensions.IMAGE_EXTENSIONS:
                try:
