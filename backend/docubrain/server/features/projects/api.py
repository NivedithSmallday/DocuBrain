...
from docubrain.db.models import Project__UserFile
from docubrain.db.models import User
from docubrain.db.models import UserFile
from docubrain.db.models import UserProject
from docubrain.db.persona import get_personas_by_ids
from docubrain.db.projects import get_project_token_count
from docubrain.db.projects import upload_files_to_user_files_with_indexing
from docubrain.server.features.projects.models import CategorizedFilesSnapshot
from docubrain.server.features.projects.models import ChatSessionRequest
from docubrain.server.features.projects.models import TokenCountResponse
from docubrain.server.features.projects.models import UserFileSnapshot
from docubrain.server.features.projects.models import UserProjectSnapshot
...
def _trigger_user_file_project_sync(
    ...
    if DISABLE_VECTOR_DB and background_tasks is not None:
        from docubrain.background.task_utils import drain_project_sync_loop
    ...
    from docubrain.background.celery.tasks.user_file_processing.tasks import (
...
def delete_user_file(
    ...
    if DISABLE_VECTOR_DB:
        from docubrain.background.task_utils import drain_delete_loop
