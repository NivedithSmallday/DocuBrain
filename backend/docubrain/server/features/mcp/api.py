...
from docubrain.db.mcp import create_connection_config
from docubrain.db.mcp import create_mcp_server__no_commit
from docubrain.db.mcp import delete_all_user_connection_configs_for_server_no_commit
from docubrain.db.mcp import delete_connection_config
from docubrain.db.mcp import delete_mcp_server
from docubrain.db.mcp import delete_user_connection_configs_for_server
from docubrain.db.mcp import extract_connection_data
from docubrain.db.mcp import get_all_mcp_servers
from docubrain.db.mcp import get_connection_config_by_id
from docubrain.db.mcp import get_mcp_server_by_id
from docubrain.db.mcp import get_mcp_servers_for_persona
from docubrain.db.mcp import get_server_auth_template
from docubrain.db.mcp import get_user_connection_config
from docubrain.db.mcp import update_connection_config
from docubrain.db.mcp import update_mcp_server__no_commit
from docubrain.db.mcp import upsert_user_connection_config
from docubrain.db.models import MCPConnectionConfig
from docubrain.db.models import MCPServer as DbMCPServer
...
from docubrain.server.features.mcp.models import MCPApiKeyResponse
from docubrain.server.features.mcp.models import MCPAuthTemplate
from docubrain.server.features.mcp.models import MCPConnectionData
from docubrain.server.features.mcp.models import MCPOAuthCallbackResponse
from docubrain.server.features.mcp.models import MCPOAuthKeys
from docubrain.server.features.mcp.models import MCPServer
from docubrain.server.features.mcp.models import MCPServerCreateResponse
from docubrain.server.features.mcp.models import MCPServerSimpleCreateRequest
from docubrain.server.features.mcp.models import MCPServerSimpleUpdateRequest
from docubrain.server.features.mcp.models import MCPServersResponse
from docubrain.server.features.mcp.models import MCPServerUpdateResponse
from docubrain.server.features.mcp.models import MCPToolCreateRequest
from docubrain.server.features.mcp.models import MCPToolListResponse
from docubrain.server.features.mcp.models import MCPToolUpdateRequest
from docubrain.server.features.mcp.models import MCPUserCredentialsRequest
from docubrain.server.features.mcp.models import MCPUserOAuthConnectRequest
from docubrain.server.features.mcp.models import MCPUserOAuthConnectResponse
from docubrain.server.features.tool.models import ToolSnapshot
from docubrain.tools.tool_implementations.mcp.mcp_client import discover_mcp_tools
from docubrain.tools.tool_implementations.mcp.mcp_client import initialize_mcp_client
from docubrain.tools.tool_implementations.mcp.mcp_client import log_exception_group
from docubrain.utils.encryption import mask_string
...
class DocubrainTokenStorage(TokenStorage):
    """
...
def make_oauth_provider(
    ...
    return OAuthClientProvider(
        ...
        client_metadata=OAuthClientMetadata(
            client_name=f"DocuBrain - {mcp_server.name}",
        ...
        storage=DocubrainTokenStorage(connection_config_id, admin_config_id),
