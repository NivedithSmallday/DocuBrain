...
from docubrain.db.document_set import check_document_sets_are_public
from docubrain.db.document_set import delete_document_set as db_delete_document_set
from docubrain.db.document_set import fetch_all_document_sets_for_user
from docubrain.db.document_set import get_document_set_by_id
from docubrain.db.document_set import insert_document_set
from docubrain.db.document_set import mark_document_set_as_to_be_deleted
from docubrain.db.document_set import update_document_set
...
from docubrain.server.features.document_set.models import CheckDocSetPublicRequest
from docubrain.server.features.document_set.models import CheckDocSetPublicResponse
from docubrain.server.features.document_set.models import DocumentSetCreationRequest
from docubrain.server.features.document_set.models import DocumentSetSummary
from docubrain.server.features.document_set.models import DocumentSetUpdateRequest
...
def create_document_set(
    ...
    if not DISABLE_VECTOR_DB:
        client_app.send_task(
            DocubrainCeleryTask.CHECK_FOR_VESPA_SYNC_TASK,
