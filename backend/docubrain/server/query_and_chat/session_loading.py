...
from docubrain.chat.citation_utils import extract_citation_order_from_text
...
from docubrain.db.chat import get_db_search_doc_by_id
from docubrain.db.chat import translate_db_search_doc_to_saved_search_doc
from docubrain.db.models import ChatMessage
from docubrain.db.tools import get_tool_by_id
from docubrain.deep_research.dr_mock_tools import RESEARCH_AGENT_IN_CODE_ID
from docubrain.deep_research.dr_mock_tools import RESEARCH_AGENT_TASK_KEY
...
from docubrain.server.query_and_chat.streaming_models import CustomToolArgs
from docubrain.server.query_and_chat.streaming_models import CustomToolDelta
from docubrain.server.query_and_chat.streaming_models import CustomToolErrorInfo
from docubrain.server.query_and_chat.streaming_models import CustomToolStart
from docubrain.server.query_and_chat.streaming_models import FileReaderResult
from docubrain.server.query_and_chat.streaming_models import FileReaderStart
from docubrain.server.query_and_chat.streaming_models import GeneratedImage
from docubrain.server.query_and_chat.streaming_models import ImageGenerationFinal
from docubrain.server.query_and_chat.streaming_models import ImageGenerationToolStart
from docubrain.server.query_and_chat.streaming_models import IntermediateReportDelta
from docubrain.server.query_and_chat.streaming_models import IntermediateReportStart
from docubrain.server.query_and_chat.streaming_models import MemoryToolDelta
from docubrain.server.query_and_chat.streaming_models import MemoryToolStart
from docubrain.server.query_and_chat.streaming_models import OpenUrlDocuments
from docubrain.server.query_and_chat.streaming_models import OpenUrlStart
from docubrain.server.query_and_chat.streaming_models import OpenUrlUrls
...
from docubrain.server.query_and_chat.streaming_models import PythonToolDelta
from docubrain.server.query_and_chat.streaming_models import PythonToolStart
...
from docubrain.server.query_and_chat.streaming_models import ResearchAgentStart
from docubrain.server.query_and_chat.streaming_models import SearchToolDocumentsDelta
from docubrain.server.query_and_chat.streaming_models import SearchToolQueriesDelta
from docubrain.server.query_and_chat.streaming_models import SearchToolStart
from docubrain.server.query_and_chat.streaming_models import SectionEnd
...
WEB_SEARCH_TOOL_IN_CODE_ID = "WebSearchTool"
IMAGE_GENERATION_TOOL_IN_CODE_ID = "ImageGenerationTool"
PYTHON_TOOL_IN_CODE_ID = "PythonTool"


def _normalize_string_list_arg(value: Any) -> list[str]:
...
def _sanitize_assistant_message_text(
...
def translate_assistant_message_to_packets(
            ...
            for tool_call in tool_calls_in_turn:
                ...
                try:
                    ...
                    if tool.in_code_tool_id in [
                        SearchTool.__name__,
                        WEB_SEARCH_TOOL_IN_CODE_ID,
                    ]:
                        queries = _normalize_string_list_arg(
                            tool_call.tool_call_arguments.get("queries", [])
                        )
                        search_docs: list[SavedSearchDoc] = [
                        ...
                        urls = _normalize_string_list_arg(
                    ...
                    elif tool.in_code_tool_id == IMAGE_GENERATION_TOOL_IN_CODE_ID:
                    ...
                    elif tool.in_code_tool_id == PYTHON_TOOL_IN_CODE_ID:
                        code = cast(
                            str,
    ...
    sanitized_message = _sanitize_assistant_message_text(chat_message, db_session)
    ...
    if sanitized_message:
        if "generation was stopped" in sanitized_message.lower():
