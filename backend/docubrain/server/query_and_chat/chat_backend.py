...
from docubrain.chat.chat_processing_checker import is_chat_session_processing
from docubrain.chat.chat_state import ChatStateContainer
from docubrain.chat.chat_utils import convert_chat_history_basic
...
from docubrain.chat.chat_utils import extract_headers
from docubrain.chat.models import ChatFullResponse
from docubrain.chat.models import CreateChatSessionID
from docubrain.chat.process_message import gather_stream_full
from docubrain.chat.process_message import handle_multi_model_stream
from docubrain.chat.process_message import handle_stream_message_objects
from docubrain.chat.prompt_utils import get_default_base_system_prompt
from docubrain.chat.stop_signal_checker import set_fence
from docubrain.configs.app_configs import WEB_DOMAIN
from docubrain.configs.chat_configs import HARD_DELETE_CHATS
...
from docubrain.configs.model_configs import LITELLM_PASS_THROUGH_HEADERS
from docubrain.db.chat import add_chats_to_session_from_slack_thread
from docubrain.db.chat import delete_all_chat_sessions_for_user
from docubrain.db.chat import delete_chat_session
from docubrain.db.chat import duplicate_chat_session_for_user_from_slack
from docubrain.db.chat import get_chat_message
from docubrain.db.chat import get_chat_messages_by_session
from docubrain.db.chat import get_chat_session_by_id
from docubrain.db.chat import get_chat_sessions_by_user
from docubrain.db.chat import set_as_latest_chat_message
from docubrain.db.chat import set_preferred_response
from docubrain.db.chat import translate_db_message_to_chat_message_detail
from docubrain.db.chat import update_chat_session
from docubrain.db.chat_search import search_chat_sessions
...
from docubrain.db.feedback import create_chat_message_feedback
from docubrain.db.feedback import remove_chat_message_feedback
from docubrain.db.models import ChatSessionSharedStatus
...
from docubrain.db.user_file import get_file_id_by_user_file_id
...
from docubrain.secondary_llm_flows.chat_session_naming import generate_chat_session_name
from docubrain.server.api_key_usage import check_api_key_usage
from docubrain.server.query_and_chat.models import ChatFeedbackRequest
from docubrain.server.query_and_chat.models import ChatMessageIdentifier
from docubrain.server.query_and_chat.models import ChatRenameRequest
from docubrain.server.query_and_chat.models import ChatSearchResponse
from docubrain.server.query_and_chat.models import ChatSessionCreationRequest
from docubrain.server.query_and_chat.models import ChatSessionDetailResponse
from docubrain.server.query_and_chat.models import ChatSessionDetails
from docubrain.server.query_and_chat.models import ChatSessionGroup
from docubrain.server.query_and_chat.models import ChatSessionsResponse
from docubrain.server.query_and_chat.models import ChatSessionSummary
from docubrain.server.query_and_chat.models import ChatSessionUpdateRequest
from docubrain.server.query_and_chat.models import MessageOrigin
from docubrain.server.query_and_chat.models import RenameChatSessionResponse
from docubrain.server.query_and_chat.models import SendMessageRequest
from docubrain.server.query_and_chat.models import SetPreferredResponseRequest
from docubrain.server.query_and_chat.models import UpdateChatSessionTemperatureRequest
from docubrain.server.query_and_chat.models import UpdateChatSessionThreadRequest
from docubrain.server.query_and_chat.session_loading import (
    translate_assistant_message_to_packets,
)
from docubrain.server.query_and_chat.streaming_models import Packet
from docubrain.server.query_and_chat.token_limit import check_token_rate_limits
...
from docubrain.server.usage_limits import is_usage_limits_enabled
from docubrain.server.utils import get_json_line
from docubrain.tracing.framework.create import ensure_trace
from docubrain.utils.headers import get_custom_tool_additional_request_headers
...
def handle_send_chat_message(
    ...
    # Streaming path, normal DocuBrain UI behavior
...
async def search_chats(
    ...
    chat_sessions, has_more = search_chat_sessions(
        ...
        page_size=page_size,
        include_deleted=False,
        include_docubrainbot_flows=False,
    )
