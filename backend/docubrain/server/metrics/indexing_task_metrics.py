...
Usage in a worker app module:
    from docubrain.server.metrics.indexing_task_metrics import (
...
from docubrain.server.metrics.celery_task_metrics import _MAX_START_TIME_AGE_SECONDS
...
INDEXING_TASK_DURATION = Histogram(
    "docubrain_indexing_task_duration_seconds",
