...
_QUEUE_LABEL_MAP: dict[str, str] = {
    DocubrainCeleryQueues.PRIMARY: "primary",
    DocubrainCeleryQueues.DOCPROCESSING: "docprocessing",
    DocubrainCeleryQueues.CONNECTOR_DOC_FETCHING: "docfetching",
    DocubrainCeleryQueues.VESPA_METADATA_SYNC: "vespa_metadata_sync",
    DocubrainCeleryQueues.CONNECTOR_DELETION: "connector_deletion",
    DocubrainCeleryQueues.CONNECTOR_PRUNING: "connector_pruning",
    DocubrainCeleryQueues.CONNECTOR_DOC_PERMISSIONS_SYNC: "permissions_sync",
    DocubrainCeleryQueues.CONNECTOR_EXTERNAL_GROUP_SYNC: "external_group_sync",
    DocubrainCeleryQueues.DOC_PERMISSIONS_UPSERT: "permissions_upsert",
    DocubrainCeleryQueues.CONNECTOR_HIERARCHY_FETCHING: "hierarchy_fetching",
    DocubrainCeleryQueues.LLM_MODEL_UPDATE: "llm_model_update",
    DocubrainCeleryQueues.CHECKPOINT_CLEANUP: "checkpoint_cleanup",
    DocubrainCeleryQueues.INDEX_ATTEMPT_CLEANUP: "index_attempt_cleanup",
    DocubrainCeleryQueues.CSV_GENERATION: "csv_generation",
    DocubrainCeleryQueues.USER_FILE_PROCESSING: "user_file_processing",
    DocubrainCeleryQueues.USER_FILE_PROJECT_SYNC: "user_file_project_sync",
    DocubrainCeleryQueues.USER_FILE_DELETE: "user_file_delete",
    DocubrainCeleryQueues.MONITORING: "monitoring",
    DocubrainCeleryQueues.SANDBOX: "sandbox",
    DocubrainCeleryQueues.OPENSEARCH_MIGRATION: "opensearch_migration",
}
...
_UNACKED_QUEUES: list[str] = [
    ...
    DocubrainCeleryQueues.DOCPROCESSING,
]
...
class IndexAttemptCollector(_CachedCollector):
    ...
    def _collect_fresh(self) -> list[GaugeMetricFamily]:
        ...
        from docubrain.db.index_attempt import get_active_index_attempts_for_metrics
        from shared_configs.contextvars import CURRENT_TENANT_ID_CONTEXTVAR

        attempts_gauge = GaugeMetricFamily(
            "docubrain_index_attempts_active",
...
class ConnectorHealthCollector(_CachedCollector):
    ...
    def _collect_fresh(self) -> list[GaugeMetricFamily]:
        ...
        from docubrain.db.engine.sql_engine import get_session_with_current_tenant
        from docubrain.db.engine.tenant_utils import get_all_tenant_ids
        from docubrain.db.index_attempt import get_docs_indexed_by_cc_pair
        from docubrain.db.index_attempt import get_failed_attempt_counts_by_cc_pair
        from shared_configs.contextvars import CURRENT_TENANT_ID_CONTEXTVAR

        staleness_gauge = GaugeMetricFamily(
            "docubrain_connector_last_success_age_seconds",
        ...
        docs_success_gauge = GaugeMetricFamily(
            "docubrain_connector_docs_indexed",
        ...
        docs_error_gauge = GaugeMetricFamily(
            "docubrain_connector_error_count",
