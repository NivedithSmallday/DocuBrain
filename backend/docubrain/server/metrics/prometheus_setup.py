"""Prometheus metrics setup for the DocuBrain API server.
...
from docubrain.server.metrics.postgres_connection_pool import pool_timeout_handler
...
def setup_prometheus_metrics(app: Starlette) -> None:
    """Initialize HTTP request metrics for the DocuBrain API server.
