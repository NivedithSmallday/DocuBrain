...
TASK_STARTED = Counter(
    "docubrain_celery_task_started_total",
    "Total Celery tasks started",
    ["task_name", "queue"],
)

TASK_COMPLETED = Counter(
    "docubrain_celery_task_completed_total",
    "Total Celery tasks completed",
    ["task_name", "queue", "outcome"],
)

TASK_DURATION = Histogram(
    "docubrain_celery_task_duration_seconds",
