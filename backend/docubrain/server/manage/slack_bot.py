...
from docubrain.db.slack_bot import insert_slack_bot
from docubrain.db.slack_bot import remove_slack_bot
from docubrain.db.slack_bot import update_slack_bot
from docubrain.db.slack_channel_config import create_slack_channel_persona
from docubrain.db.slack_channel_config import fetch_slack_channel_config
from docubrain.db.slack_channel_config import fetch_slack_channel_configs
from docubrain.db.slack_channel_config import insert_slack_channel_config
from docubrain.db.slack_channel_config import remove_slack_channel_config
from docubrain.db.slack_channel_config import update_slack_channel_config
from docubrain.docubrainbot.slack.config import validate_channel_name
from docubrain.server.manage.models import SlackBot
from docubrain.server.manage.models import SlackBotCreationRequest
from docubrain.server.manage.models import SlackChannelConfig
from docubrain.server.manage.models import SlackChannelConfigCreationRequest
from docubrain.server.manage.validate_tokens import validate_app_token
from docubrain.server.manage.validate_tokens import validate_bot_token
from docubrain.server.manage.validate_tokens import validate_user_token
...
def _form_channel_config(
    ...
    if respond_tag_only and respond_member_group_list:
        raise ValueError(
            "Cannot set DocubrainBot to only respond to tags only and also respond to a predetermined set of users."
        )
    ...
    if (
        ...
        raise ValueError(
            "Cannot set DocubrainBot to respond to users in a private (ephemeral) message "
...
def create_bot(
    ...
    mt_cloud_telemetry(
        ...
        event=MilestoneRecordType.CREATED_DOCUBRAIN_BOT,
    )
