...
from docubrain.db.enums import LLMModelFlowType
from docubrain.db.enums import Permission
from docubrain.db.llm import can_user_access_llm_provider
from docubrain.db.llm import fetch_default_llm_model
from docubrain.db.llm import fetch_default_vision_model
from docubrain.db.llm import fetch_existing_llm_provider
from docubrain.db.llm import fetch_existing_llm_provider_by_id
from docubrain.db.llm import fetch_existing_llm_providers
from docubrain.db.llm import fetch_existing_models
from docubrain.db.llm import fetch_persona_with_groups
from docubrain.db.llm import fetch_user_group_ids
from docubrain.db.llm import remove_llm_provider
from docubrain.db.llm import sync_model_configurations
from docubrain.db.llm import update_default_provider
from docubrain.db.llm import update_default_vision_provider
from docubrain.db.llm import upsert_llm_provider
from docubrain.db.llm import validate_persona_ids_exist
from docubrain.db.models import User
from docubrain.db.persona import user_can_access_persona
...
from docubrain.llm.constants import PROVIDER_DISPLAY_NAMES
from docubrain.llm.constants import WELL_KNOWN_PROVIDER_NAMES
from docubrain.llm.factory import get_default_llm
from docubrain.llm.factory import get_llm
from docubrain.llm.factory import get_max_input_tokens_from_llm_provider
from docubrain.llm.utils import get_bedrock_token_limit
from docubrain.llm.utils import get_llm_contextual_cost
from docubrain.llm.utils import test_llm
from docubrain.llm.well_known_providers.auto_update_service import (
...
from docubrain.server.manage.llm.models import BedrockFinalModelResponse
from docubrain.server.manage.llm.models import BedrockModelsRequest
from docubrain.server.manage.llm.models import BifrostFinalModelResponse
from docubrain.server.manage.llm.models import BifrostModelsRequest
from docubrain.server.manage.llm.models import CustomProviderOption
from docubrain.server.manage.llm.models import DefaultModel
from docubrain.server.manage.llm.models import LitellmFinalModelResponse
from docubrain.server.manage.llm.models import LitellmModelDetails
from docubrain.server.manage.llm.models import LitellmModelsRequest
from docubrain.server.manage.llm.models import LLMCost
from docubrain.server.manage.llm.models import LLMProviderDescriptor
from docubrain.server.manage.llm.models import LLMProviderResponse
from docubrain.server.manage.llm.models import LLMProviderUpsertRequest
...
from docubrain.server.manage.llm.models import OllamaModelsRequest
from docubrain.server.manage.llm.models import OpenAICompatibleFinalModelResponse
from docubrain.server.manage.llm.models import OpenAICompatibleModelsRequest
from docubrain.server.manage.llm.models import OpenRouterFinalModelResponse
from docubrain.server.manage.llm.models import OpenRouterModelDetails
from docubrain.server.manage.llm.models import OpenRouterModelsRequest
from docubrain.server.manage.llm.models import SyncModelEntry
from docubrain.server.manage.llm.models import TestLLMRequest
from docubrain.server.manage.llm.models import VisionProviderResponse
from docubrain.server.manage.llm.utils import generate_bedrock_display_name
from docubrain.server.manage.llm.utils import generate_ollama_display_name
from docubrain.server.manage.llm.utils import infer_vision_support
from docubrain.server.manage.llm.utils import is_embedding_model
from docubrain.server.manage.llm.utils import is_reasoning_model
from docubrain.server.manage.llm.utils import is_valid_bedrock_model
from docubrain.server.manage.llm.utils import ModelMetadata
from docubrain.server.manage.llm.utils import strip_openrouter_vendor_prefix
from docubrain.utils.encryption import mask_string as mask_with_ellipsis
...
def _validate_llm_provider_change(
    ...
    Raises:
        DocubrainError: If api_base or custom_config changed without changing API key
    """
...
def fetch_llm_provider_options(
    ...
    raise DocubrainError(DocubrainErrorCode.NOT_FOUND, f"Provider {provider_name} not found")
...
def test_llm_configuration(
    ...
    if error_msg:
        raise DocubrainError(DocubrainErrorCode.VALIDATION_ERROR, error_msg)
...
def test_default_provider(
    ...
    try:
        ...
        raise DocubrainError(DocubrainErrorCode.VALIDATION_ERROR, "No LLM Provider setup")

    error = test_llm(llm)
    if error:
        raise DocubrainError(DocubrainErrorCode.VALIDATION_ERROR, str(error))
...
def list_llm_providers(
    ...
    for llm_provider_model in fetch_existing_llm_providers(
        db_session=db_session,
        flow_type_filter=[],
        exclude_image_generation_providers=True,
    ):
...
def put_llm_provider(
    ...
    if found_provider is not None and found_provider is not existing_provider:
        raise DocubrainError(
            DocubrainErrorCode.DUPLICATE_RESOURCE,
    ...
    try:
        ...
        if transitioning_to_auto_mode:
            from docubrain.db.llm import sync_auto_mode_models
        ...
        raise DocubrainError(DocubrainErrorCode.VALIDATION_ERROR, str(e))
...
def delete_llm_provider(
    ...
    try:
        ...
        raise DocubrainError(DocubrainErrorCode.NOT_FOUND, str(e))
...
def list_llm_providers_for_persona(
    ...
    persona = fetch_persona_with_groups(db_session, persona_id)
    if not persona:
        raise DocubrainError(DocubrainErrorCode.PERSONA_NOT_FOUND, "Persona not found")
...
def get_bedrock_available_models(
    ...
    try:
        ...
        raise DocubrainError(
            DocubrainErrorCode.INTERNAL_ERROR,
...
def _get_openrouter_models_response(api_base: str, api_key: str) -> dict:
    ...
    headers = {
        ...
        "HTTP-Referer": "https://docubrain.app",
        "X-Title": "DocuBrain",
    }
    try:
