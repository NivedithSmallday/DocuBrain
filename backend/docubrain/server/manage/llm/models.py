...
from docubrain.llm.utils import litellm_thinks_model_supports_image_input
from docubrain.llm.utils import model_is_reasoning_model
from docubrain.server.manage.llm.utils import DYNAMIC_LLM_PROVIDERS
from docubrain.server.manage.llm.utils import extract_vendor_from_model_name
from docubrain.server.manage.llm.utils import filter_model_configurations
...
class ModelConfigurationView(BaseModel):
    ...
    def from_model(
        ...
        from docubrain.llm.model_name_parser import parse_litellm_model_name
