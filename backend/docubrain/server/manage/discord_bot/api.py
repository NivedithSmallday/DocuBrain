...
from docubrain.configs.app_configs import DISCORD_BOT_TOKEN
from docubrain.configs.constants import AuthType
from docubrain.db.discord_bot import create_discord_bot_config
from docubrain.db.discord_bot import create_guild_config
from docubrain.db.discord_bot import delete_discord_bot_config
from docubrain.db.discord_bot import delete_discord_service_api_key
from docubrain.db.discord_bot import delete_guild_config
from docubrain.db.discord_bot import get_channel_config_by_internal_ids
from docubrain.db.discord_bot import get_channel_configs
from docubrain.db.discord_bot import get_discord_bot_config
from docubrain.db.discord_bot import get_guild_config_by_internal_id
from docubrain.db.discord_bot import get_guild_configs
from docubrain.db.discord_bot import update_discord_channel_config
from docubrain.db.discord_bot import update_guild_config
...
from docubrain.server.manage.discord_bot.models import DiscordBotConfigCreateRequest
from docubrain.server.manage.discord_bot.models import DiscordBotConfigResponse
from docubrain.server.manage.discord_bot.models import DiscordChannelConfigResponse
from docubrain.server.manage.discord_bot.models import DiscordChannelConfigUpdateRequest
from docubrain.server.manage.discord_bot.models import DiscordGuildConfigCreateResponse
from docubrain.server.manage.discord_bot.models import DiscordGuildConfigResponse
from docubrain.server.manage.discord_bot.models import DiscordGuildConfigUpdateRequest
from docubrain.server.manage.discord_bot.utils import (
...
def _check_bot_config_api_access() -> None:
    ...
    - On Cloud (managed by DocuBrain)
    - When DISCORD_BOT_TOKEN env var is set (managed via env)
    """
    if AUTH_TYPE == AuthType.CLOUD:
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="Discord bot configuration is managed by DocuBrain on Cloud.",
        )
...
def delete_service_api_key_endpoint(
    ...
    Discord bot to authenticate with the DocuBrain API. The key is also automatically
    deleted when:
