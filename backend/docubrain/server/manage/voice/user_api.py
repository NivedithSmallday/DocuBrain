...
from docubrain.redis.redis_pool import store_ws_token
from docubrain.redis.redis_pool import WsTokenRateLimitExceeded
from docubrain.server.manage.models import VoiceSettingsUpdateRequest
...
async def transcribe_audio(
    ...
    while chunk := await audio.read(UPLOAD_READ_CHUNK_SIZE):
        ...
        if total > MAX_AUDIO_SIZE:
            raise DocubrainError(
                DocubrainErrorCode.PAYLOAD_TOO_LARGE,
    ...
    try:
        ...
        raise DocubrainError(DocubrainErrorCode.INTERNAL_ERROR, str(exc)) from exc
    ...
    try:
        ...
        raise DocubrainError(
            DocubrainErrorCode.NOT_IMPLEMENTED,
...
async def synthesize_speech(
    ...
    if not text:
        raise DocubrainError(DocubrainErrorCode.VALIDATION_ERROR, "Text is required")
...
async def get_ws_token(
    ...
    try:
        ...
        raise DocubrainError(
            DocubrainErrorCode.RATE_LIMITED,
