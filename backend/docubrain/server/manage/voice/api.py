...
from docubrain.db.models import LLMProvider as LLMProviderModel
from docubrain.db.models import User
from docubrain.db.models import VoiceProvider
from docubrain.db.voice import deactivate_stt_provider
from docubrain.db.voice import deactivate_tts_provider
from docubrain.db.voice import delete_voice_provider
from docubrain.db.voice import fetch_voice_provider_by_id
from docubrain.db.voice import fetch_voice_provider_by_type
from docubrain.db.voice import fetch_voice_providers
from docubrain.db.voice import set_default_stt_provider
from docubrain.db.voice import set_default_tts_provider
from docubrain.db.voice import upsert_voice_provider
...
from docubrain.server.manage.voice.models import VoiceOption
from docubrain.server.manage.voice.models import VoiceProviderTestRequest
from docubrain.server.manage.voice.models import VoiceProviderUpdateSuccess
from docubrain.server.manage.voice.models import VoiceProviderUpsertRequest
from docubrain.server.manage.voice.models import VoiceProviderView
from docubrain.utils.logger import setup_logger
from docubrain.utils.url import SSRFException
from docubrain.utils.url import validate_outbound_http_url
from docubrain.voice.factory import get_voice_provider
...
async def test_voice_provider(
    ...
    try:
        ...
        raise DocubrainError(DocubrainErrorCode.VALIDATION_ERROR, str(exc)) from exc
...
def get_provider_voices(
    ...
    if provider_db is None:
        raise DocubrainError(DocubrainErrorCode.NOT_FOUND, "Voice provider not found.")

    if not provider_db.api_key:
        raise DocubrainError(
            DocubrainErrorCode.VALIDATION_ERROR, "Provider has no API key configured."
        )
