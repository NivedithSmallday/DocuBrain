...
from docubrain.context.search.models import SearchSettingsCreationRequest
...
from docubrain.db.llm import update_default_contextual_model
from docubrain.db.llm import update_no_default_contextual_rag_provider
from docubrain.db.models import IndexModelStatus
from docubrain.db.models import User
from docubrain.db.search_settings import create_search_settings
from docubrain.db.search_settings import delete_search_settings
from docubrain.db.search_settings import get_current_search_settings
from docubrain.db.search_settings import get_embedding_provider_from_provider_type
...
from docubrain.db.search_settings import update_search_settings_status
from docubrain.document_index.factory import get_all_document_indices
from docubrain.document_index.factory import get_default_document_index
from docubrain.file_processing.unstructured import delete_unstructured_api_key
from docubrain.file_processing.unstructured import get_unstructured_api_key
from docubrain.file_processing.unstructured import update_unstructured_api_key
from docubrain.natural_language_processing.search_nlp_models import clean_model_name
from docubrain.server.manage.embedding.models import SearchSettingsDeleteRequest
from docubrain.server.manage.models import FullModelVersionResponse
from docubrain.server.models import IdReturn
...
def set_new_search_settings(
    ...
    if MULTI_TENANT and search_settings_new.enable_contextual_rag:
        raise HTTPException(
            ...
            detail="Contextual RAG disabled in DocuBrain Cloud",
        )
