...
from docubrain.auth.users import user_needs_to_be_verified
...
from docubrain.configs.constants import DEV_VERSION_PATTERN
from docubrain.configs.constants import PUBLIC_API_TAGS
from docubrain.configs.constants import STABLE_VERSION_PATTERN
from docubrain.db.auth import get_user_count
from docubrain.server.manage.models import AllVersions
from docubrain.server.manage.models import AuthTypeResponse
from docubrain.server.manage.models import ContainerVersions
from docubrain.server.manage.models import VersionResponse
...
def get_versions() -> AllVersions:
    """
    Fetches the latest stable and beta versions of DocuBrain Docker images.
    ...
    """
    # Fetch the latest tags from DockerHub for each DocuBrain component
    dockerhub_repos = [
        "docubraindotapp/docubrain-model-server",
        "docubraindotapp/docubrain-backend",
        "docubraindotapp/docubrain-web-server",
    ]
