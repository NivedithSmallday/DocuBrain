...
class DocubrainJSONEncoder(json.JSONEncoder):
...
def get_json_line(
    json_dict: dict[str, Any], encoder: type[json.JSONEncoder] = DocubrainJSONEncoder
) -> str:
    """
    ...
    Args:
        ...
        encoder: JSON encoder class to use, defaults to DocubrainJSONEncoder.
