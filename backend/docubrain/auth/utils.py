...
from docubrain.auth.constants import API_KEY_HEADER_ALTERNATIVE_NAME
from docubrain.auth.constants import API_KEY_HEADER_NAME
from docubrain.auth.constants import API_KEY_PREFIX
from docubrain.auth.constants import BEARER_PREFIX
from docubrain.auth.constants import DEPRECATED_API_KEY_PREFIX
from docubrain.auth.constants import PAT_PREFIX
...
def get_hashed_bearer_token_from_request(
    ...
    Args:
        ...
        valid_prefixes: List of valid token prefixes (e.g., ["on_", "docubrain_pat_"])
