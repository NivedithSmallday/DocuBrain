...
from docubrain.configs.docubrainbot_configs import DOCUBRAIN_BOT_NUM_DOCS_TO_DISPLAY
from docubrain.context.search.models import SearchDoc
from docubrain.db.chat import get_chat_session_by_message_id
from docubrain.db.engine.sql_engine import get_session_with_current_tenant
from docubrain.db.models import ChannelConfig
from docubrain.docubrainbot.slack.constants import CONTINUE_IN_WEB_UI_ACTION_ID
...
from docubrain.docubrainbot.slack.formatting import format_slack_message
from docubrain.docubrainbot.slack.icons import source_to_github_img_link
from docubrain.docubrainbot.slack.models import ActionValuesEphemeralMessage
from docubrain.docubrainbot.slack.models import ActionValuesEphemeralMessageChannelConfig
from docubrain.docubrainbot.slack.models import ActionValuesEphemeralMessageMessageInfo
from docubrain.docubrainbot.slack.models import SlackMessageInfo
from docubrain.docubrainbot.slack.utils import build_continue_in_web_ui_id
from docubrain.docubrainbot.slack.utils import build_feedback_id
from docubrain.docubrainbot.slack.utils import build_publish_ephemeral_message_id
from docubrain.docubrainbot.slack.utils import remove_slack_text_interactions
from docubrain.docubrainbot.slack.utils import translate_vespa_highlight_to_slack
from docubrain.utils.text_processing import decode_escapes
...
def _build_documents_blocks(
    ...
    message_id: int | None,
    num_docs_to_display: int = DOCUBRAIN_BOT_NUM_DOCS_TO_DISPLAY,
) -> list[Block]:
        ...
        return ActionsBlock(
            ...
            elements=[
                ButtonElement(
                    ...
                    text="Continue Chat in DocuBrain!",
                    style="primary",
...
def build_slack_response_blocks(
    ...
    """
    # If called with the DocubrainBot slash command, the question is lost so we have to reshow it
