...
class SlackMessageInfo(BaseModel):
    ...
    sender_id: str | None
    email: str | None
    bypass_filters: bool  # User has tagged @DocubrainBot
    is_slash_command: bool  # User is using /DocubrainBot
    is_bot_dm: bool  # User is direct messaging to DocubrainBot
