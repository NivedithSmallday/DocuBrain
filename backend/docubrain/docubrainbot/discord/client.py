...
from docubrain.docubrainbot.discord.constants import CACHE_REFRESH_INTERVAL
...
from docubrain.docubrainbot.discord.handle_message import should_respond
from docubrain.docubrainbot.discord.utils import get_bot_token
from docubrain.utils.logger import setup_logger

logger = setup_logger()


class DocubrainDiscordClient(commands.Bot):
    ...
    def __init__(self, command_prefix: str = DISCORD_BOT_INVOKE_CHAR) -> None:
        ...
        self.api_client = DocubrainAPIClient()
...
def main() -> None:
    ...
    logger.info("Starting DocuBrain Discord Bot...")
