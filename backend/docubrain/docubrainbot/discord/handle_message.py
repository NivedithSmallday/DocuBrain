...
from docubrain.db.discord_bot import get_channel_config_by_discord_ids
...
from docubrain.db.models import DiscordChannelConfig
from docubrain.db.models import DiscordGuildConfig
from docubrain.docubrainbot.discord.api_client import DocubrainAPIClient
from docubrain.docubrainbot.discord.constants import MAX_CONTEXT_MESSAGES
from docubrain.docubrainbot.discord.constants import MAX_MESSAGE_LENGTH
from docubrain.docubrainbot.discord.constants import THINKING_EMOJI
from docubrain.docubrainbot.discord.exceptions import APIError
...
def _format_messages_as_context(
    ...
    for msg in messages:
        ...
        sender = (
            "DocubrainBot" if msg.author.id == bot_user.id else f"@{msg.author.display_name}"
        )
    ...
    return (
        "You are a Discord bot named DocubrainBot.\n"
...
async def send_response(
    ...
    if isinstance(message.channel, discord.Thread):
        ...
        thread_name = f"DocubrainBot <> {message.author.display_name}"[:100]
...
async def send_error_response(
    ...
    error_msg = "Sorry, I encountered an error processing your message. You may want to contact DocuBrain for support :sweat_smile:"
