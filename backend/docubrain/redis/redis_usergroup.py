...
from docubrain.configs.app_configs import DB_YIELD_PER_DEFAULT
...
from docubrain.redis.redis_object_helper import RedisObjectHelper
    ...
    def generate_tasks(
        ...
        for doc_id in db_session.scalars(stmt).yield_per(DB_YIELD_PER_DEFAULT):
            ...
            celery_app.send_task(
                DocubrainCeleryTask.VESPA_METADATA_SYNC_TASK,
                kwargs=dict(document_id=doc_id, tenant_id=tenant_id),
                queue=DocubrainCeleryQueues.VESPA_METADATA_SYNC,
