...
from docubrain.configs.app_configs import BRAINTRUST_PROJECT
from docubrain.configs.app_configs import LANGFUSE_HOST
from docubrain.configs.app_configs import LANGFUSE_PUBLIC_KEY
from docubrain.configs.app_configs import LANGFUSE_SECRET_KEY
...
def _setup_braintrust() -> None:
    ...
    from docubrain.tracing.braintrust_tracing_processor import BraintrustTracingProcessor
    from docubrain.tracing.framework import add_trace_processor
    from docubrain.tracing.masking import mask_sensitive_data
...
def _setup_langfuse() -> None:
    ...
    from docubrain.tracing.framework import add_trace_processor
    from docubrain.tracing.langfuse_tracing_processor import LangfuseTracingProcessor
