...
from docubrain.deep_research.dr_mock_tools import GENERATE_REPORT_TOOL_NAME
from docubrain.deep_research.dr_mock_tools import THINK_TOOL_NAME
from docubrain.deep_research.models import SpecialToolCalls
