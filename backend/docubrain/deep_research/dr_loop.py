...
from docubrain.configs.chat_configs import SKIP_DEEP_RESEARCH_CLARIFICATION
from docubrain.configs.constants import MessageType
from docubrain.db.tools import get_tool_by_name
from docubrain.deep_research.dr_mock_tools import get_clarification_tool_definitions
from docubrain.deep_research.dr_mock_tools import get_orchestrator_tools
from docubrain.deep_research.dr_mock_tools import RESEARCH_AGENT_TOOL_NAME
...
from docubrain.prompts.deep_research.orchestration_layer import CLARIFICATION_PROMPT
from docubrain.prompts.deep_research.orchestration_layer import FINAL_REPORT_PROMPT
from docubrain.prompts.deep_research.orchestration_layer import FIRST_CYCLE_REMINDER
from docubrain.prompts.deep_research.orchestration_layer import FIRST_CYCLE_REMINDER_TOKENS
from docubrain.prompts.deep_research.orchestration_layer import (
    INTERNAL_SEARCH_CLARIFICATION_GUIDANCE,
)
from docubrain.prompts.deep_research.orchestration_layer import (
    INTERNAL_SEARCH_RESEARCH_TASK_GUIDANCE,
)
from docubrain.prompts.deep_research.orchestration_layer import ORCHESTRATOR_PROMPT
from docubrain.prompts.deep_research.orchestration_layer import ORCHESTRATOR_PROMPT_REASONING
from docubrain.prompts.deep_research.orchestration_layer import RESEARCH_PLAN_PROMPT
from docubrain.prompts.deep_research.orchestration_layer import RESEARCH_PLAN_REMINDER
from docubrain.prompts.deep_research.orchestration_layer import USER_FINAL_REPORT_QUERY
...
from docubrain.server.query_and_chat.streaming_models import DeepResearchPlanDelta
from docubrain.server.query_and_chat.streaming_models import DeepResearchPlanStart
...
from docubrain.tools.fake_tools.research_agent import run_research_agent_calls
...
def run_deep_research_llm_loop(
    ...
    with trace(
        ...
        from docubrain.llm.litellm_singleton.config import initialize_litellm
