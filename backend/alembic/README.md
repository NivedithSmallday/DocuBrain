<!-- DOCUBRAIN_METADATA={"link": "https://github.com/docubrain-dot-app/docubrain/blob/main/backend/alembic/README.md"} -->

# Alembic DB Migrations

These files are for creating/updating the tables in the Relational DB (Postgres).
DocuBrain migrations use a generic single-database configuration with an async dbapi.

## To generate new migrations:

From docubrain/backend, run:
