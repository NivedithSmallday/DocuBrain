...
This script uses DocuBrain's LiteLLM instance (with monkey patches) to make a completion
...
MESSAGES = [
    ...
    {"role": "user", "content": "what is docubrain? search internally and the web"},
]
