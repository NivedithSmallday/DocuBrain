...
# Now import DocuBrain modules
from docubrain.db.models import (
...
from docubrain.document_index.factory import (
...
def _delete_connector(cc_pair_id: int, db_session: Session) -> None:
    user_input = input(
        ...
        IT MAY CAUSE ISSUES with your DocuBrain instance! \
