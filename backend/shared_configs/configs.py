...
# DocuBrain custom Deep Learning Models
CONNECTOR_CLASSIFIER_MODEL_REPO = "Danswer/filter-extraction-model"
CONNECTOR_CLASSIFIER_MODEL_TAG = "1.0.0"
INTENT_MODEL_VERSION = "docubrain-dot-app/hybrid-intent-token-classifier"
...
LOG_FILE_NAME = os.environ.get("LOG_FILE_NAME") or "docubrain"
